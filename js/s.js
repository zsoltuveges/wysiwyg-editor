...
!function (n) {
    ...
    Ee.FE.LinkRegExCommon = "[a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_.]{1,}", Ee.FE.LinkRegExEnd = "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;/~+#-\\'*-_{}]*)|())", Ee.FE.LinkRegExTLD = "((" + Ee.FE.LinkRegExCommon + ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))", Ee.FE.LinkRegExHTTP = "((ftp|http|https):\\/\\/" + Ee.FE.LinkRegExCommon + ")", Ee.FE.LinkRegExAuth = "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@" + Ee.FE.LinkRegExCommon + ")", Ee.FE.LinkRegExWWW = "(www\\." + Ee.FE.LinkRegExCommon + "\\.[a-z0-9-]{2,24})", Ee.FE.LinkRegEx = "(" + Ee.FE.LinkRegExTLD + "|" + Ee.FE.LinkRegExHTTP + "|" + Ee.FE.LinkRegExWWW + "|" + Ee.FE.LinkRegExAuth + ")" + Ee.FE.LinkRegExEnd, Ee.FE.LinkProtocols = ["mailto", "tel", "sms", "notes", "data"], Ee.FE.MAIL_REGEX = /.+@.+\..+/i, Ee.FE.MODULES.helpers = function (a) {
        ...
        function n(e) {
            ...
            if (!l.core.hasFocus() && e) {
                ...
                if (l.browser.msie && l.$box && l.$box.css("position", "fixed"), l.browser.msie && l.$wp && l.$wp.css("overflow", "visible"), a(), l.$el.focus(), l.events.trigger("focus"), i(), l.browser.msie && l.$box && l.$box.css("position", ""), l.browser.msie && l.$wp && l.$wp.css("overflow", "auto"), t != l.$win.scrollTop() && l.$win.scrollTop(t), !l.selection.info(l.el).atStart) return !1
            }
            ...
            if (l.selection.info(l.el).atStart && l.selection.isCollapsed() && null != l.html.defaultTag()) {
                ...
                if (n && !l.node.blockParent(n)) {
                    ...
                    r && (Ee(r).prepend(Ee.FE.MARKERS), l.selection.restore())
                } else n && Ee(n).remove()
            }
        }
        ...
        function f(e, t, n, r, i) {
            ...
            var a, o = i ? l.shared.$_events : c, s = i ? l.sid : l.id;
            a = r, r = function () {
        ...
        function u(e, t, n) {
            if (!l.edit.isDisabled() || n) {
                ...
                if (r) for (var a = 0; a < r.length; a++) if (!1 === (i = r[a].apply(l, t))) return !1;
        ...
        return {
            ...
            }, disableBlur: a, enableBlur: i, blurActive: s, focus: n, chainTrigger: function (e, t, n) {
                if (!l.edit.isDisabled() || n) {
                    var r, i;
                    if (0 !== e.indexOf("shared.")) r = o[e]; else {
                        if (0 < l.shared.count) return !1;
                    ...
                    if (r) for (var a = 0; a < r.length; a++) void 0 !== (i = r[a].apply(l, [t])) && (t = i);
        ...
        function E(e) {
            ...
            !function (e) {
                ...
                if (c.opts.htmlAllowComments || e.nodeType != Node.COMMENT_NODE) if (e.tagName && e.tagName.match(p)) e.parentNode.removeChild(e); else if (e.tagName && !e.tagName.match(f)) "svg" === e.tagName ? e.parentNode.removeChild(e) : c.browser.safari && "path" == e.tagName && e.parentNode && "svg" == e.parentNode.tagName || (c.browser.safari ? e.replaceWith(e.innerHTML) : e.outerHTML = e.innerHTML); else {
                    var a = e.attributes;
        ...
        return {
            _init: function () {
                ...
                !function () {
                    ...
                    for (var e = c.el.querySelectorAll("ul, ol"), t = 0; t < e.length; t++) for (var n = c.node.contents(e[t]), r = null, i = n.length - 1; 0 <= i; i--) "LI" != n[i].tagName && "UL" != n[i].tagName && "OL" != n[i].tagName ? (r || (r = Ee("<li>")).insertBefore(n[i]), r.prepend(n[i])) : r = null
                }(), function () {
                    var e, t, n;
                    do {
                        t = !1;
        ...
        function r(e, t) {
            ...
            if (!l.html.isPreformatted(a)) {
                ...
                for (var o = "", s = 0; s < i.length; s++) 32 != i.charCodeAt(s) || 0 !== s && 32 != o.charCodeAt(s - 1) || n && r && l.node.isVoid(n) && l.node.isVoid(r) ? o += i[s] : o += Ee.FE.UNICODE_NBSP;
        ...
        function a(e) {
            ...
            var l = p();
            for (l += "," + Ee.FE.VOID_ELEMENTS.join(","), l += ", .fr-inner", l += "," + N.opts.htmlAllowedEmptyTags.join(":not(.fr-marker),") + ":not(.fr-marker)", t = r.length - 1; 0 <= t; t--) if (!(r[t].textContent && 0 < r[t].textContent.replace(/\u200B|\n/g, "").length || 0 < r[t].querySelectorAll(l).length)) {
                for (var d = N.node.contents(r[t]), c = !1, f = 0; f < d.length; f++) if (d[f].nodeType != Node.COMMENT_NODE && d[f].textContent && 0 < d[f].textContent.replace(/\u200B|\n/g, "").length) {
                    c = !0;
                    break
                }
                c || n.push(r[t])
        ...
        return {
            defaultTag: c, isPreformatted: s, emptyBlocks: a, emptyBlockTagsQuery: function () {
                ...
                var r, i, a = [], o = {}, s = [], l = N.el.querySelectorAll("input, textarea");
                ...
                if (N.node.isEmpty(N.el)) N.opts.fullPage && (n = O(N.iframe_document), n += "<html" + N.node.attributes(N.$html.get(0)) + ">" + N.$html.find("head").get(0).outerHTML + "<body></body></html>"); else if (void 0 === e && (e = !1), N.opts.fullPage) {
                    ...
                    var y = N.opts.heightMin, _ = N.opts.height, L = N.opts.heightMax;
                ...
                if (!N.opts.useClasses && !t) for (r = 0; r < a.length; r++) a[r].getAttribute("fr-original-class") && (a[r].setAttribute("class", a[r].getAttribute("fr-original-class")), a[r].removeAttribute("fr-original-class")), null != a[r].getAttribute("fr-original-style") && void 0 !== a[r].getAttribute("fr-original-style") ? (0 !== a[r].getAttribute("fr-original-style").length ? a[r].setAttribute("style", a[r].getAttribute("fr-original-style")) : a[r].removeAttribute("style"), a[r].removeAttribute("fr-original-style")) : a[r].removeAttribute("style");
                ...
                var r, i, a;
                if (N.selection.isCollapsed() || N.selection.remove(), r = t ? e : N.clean.html(e), e.indexOf('class="fr-marker"') < 0 && (i = r, (a = N.doc.createElement("div")).innerHTML = i, N.selection.setAtEnd(a), r = a.innerHTML), N.node.isEmpty(N.el) && !N.opts.keepFormatOnDelete && f(r)) N.el.innerHTML = r; else {
        ...
        return {
            _startEnter: function (e) {
                ...
                if (g.node.isEmpty(n, !0) && r) {
                    ...
                    var d = "";
                    for (d = l.parentNode && "LI" == l.parentNode.tagName ? s + "<li>" + Ee.FE.MARKERS + "<br>" + o : a ? s + "<" + a + ">" + Ee.FE.MARKERS + "<br></" + a + ">" + o : s + Ee.FE.MARKERS + "<br>" + o; ["UL", "OL"].indexOf(l.tagName) < 0 || l.parentNode && "LI" === l.parentNode.tagName;) l = l.parentNode;
        ...
        function m(e, t, n) {
            ...
            if (null == r) u.html.defaultTag() && e.parentNode === u.el ? Ee(e).replaceWith("<" + u.html.defaultTag() + ">" + Ee.FE.MARKERS + "<br></" + u.html.defaultTag() + ">") : (e.nextSibling && !u.node.isBlock(e.nextSibling) || Ee(e).after("<br>"), Ee(e).replaceWith("<br>" + Ee.FE.MARKERS)); else {
                ...
                if ("BLOCKQUOTE" == r.tagName) if (e.previousSibling && u.node.isBlock(e.previousSibling) && e.nextSibling && "BR" == e.nextSibling.tagName && (Ee(e.nextSibling).after(e), e.nextSibling && "BR" == e.nextSibling.tagName && Ee(e.nextSibling).remove()), t) a = o + a + Ee.FE.MARKERS + s; else {
        ...
        return {
            enter: function (t) {
                ...
                u.el.normalize();
                var r = !1;
                0 < Ee(n).parentsUntil(u.$el, "BLOCKQUOTE").length && (r = !0), Ee(n).parentsUntil(u.$el, "TD, TH").length && (r = !1), a(n) ? !s(n) || t || r ? p(n, t, r) : u.cursorLists._endEnter(n) : o(n) ? !s(n) || t || r ? function e(t, n, r) {
                ...
                return a(t) ? e = c(t) : o(t) ? s(t) && h(t, Ee(t).parents("li:first").get(0)) ? u.cursorLists._backspace(t) : function (e) {
                    ...
                    if (null !== n) {
                        ...
                        if (u.node.isBlock(n) && u.node.isEditable(n) && o && Ee.FE.NO_DELETE_TAGS.indexOf(o.tagName) < 0) if (u.node.isDeletable(o)) Ee(o).remove(), Ee(e).replaceWith(Ee.FE.MARKERS); else if (u.node.isEditable(o)) if (u.node.isBlock(o)) if (u.node.isEmpty(o) && !u.node.isList(o)) Ee(o).remove(), Ee(e).after(u.opts.keepFormatOnDelete ? Ee.FE.INVISIBLE_SPACE : ""); else {
                            if (u.node.isList(o) && (o = Ee(o).find("li:last").get(0)), (a = u.node.contents(o)).length && "BR" == a[a.length - 1].tagName && Ee(a[a.length - 1]).remove(), "BLOCKQUOTE" == o.tagName && "BLOCKQUOTE" != n.tagName) for (a = u.node.contents(o); a.length && u.node.isBlock(a[a.length - 1]);) o = a[a.length - 1], a = u.node.contents(o); else if ("BLOCKQUOTE" != o.tagName && "BLOCKQUOTE" == r.tagName) for (a = u.node.contents(r); a.length && u.node.isBlock(a[0]);) r = a[0], a = u.node.contents(r);
        ...
        function o(e) {
            ...
            c = !1;
            var r, i, a, o = m(n) && !h(e) && !e.altKey, s = n == Ee.FE.KEYCODE.BACKSPACE || n == Ee.FE.KEYCODE.DELETE;
            ...
            n == Ee.FE.KEYCODE.ENTER ? e.shiftKey ? ((a = e).preventDefault(), a.stopPropagation(), l.opts.multiLine && (l.selection.isCollapsed() || l.selection.remove(), l.cursor.enter(!0))) : (i = e, l.opts.multiLine ? (l.helpers.isIOS() || (i.preventDefault(), i.stopPropagation()), l.selection.isCollapsed() || l.selection.remove(), l.cursor.enter()) : (i.preventDefault(), i.stopPropagation())) : n === Ee.FE.KEYCODE.BACKSPACE && (e.metaKey || e.ctrlKey) ? setTimeout(function () {
                ...
                } else e.preventDefault(), e.stopPropagation(); else e.preventDefault(), e.stopPropagation(), l.selection.remove();
        ...
        return {
            ...
            }, ctrlKey: h, isCharacter: m, isArrow: g, forceUndo: function () {
            ...
            if (e) {
                ...
                if (e) {
                    ...
                    if (i) (Ee(i).find(".fr-marker").length || "UL" == i.tagName || "OL" == i.tagName) && m(i.firstChild, t, n); else {
                        ...
                        if (o) {
                            for (var s = o.nextSibling; "BR" === s.tagName;) s = s.nextSibling;
            ...
            !function e(t, n, r, i) {
                for (var a = g.node.contents(t.get(0)), o = 0; o < a.length; o++) {
                    ...
                    if (g.node.hasClass(s, "fr-marker")) n = (n + 1) % 2; else if (n) if (0 < Ee(s).find(".fr-marker").length) n = e(Ee(s), n, r, i); else {
                        ...
                        void 0 === r && s.nodeType == Node.ELEMENT_NODE && !g.node.isVoid(s) || p(s, f(r, i)) ? g.node.isBlock(s) || Ee(s).replaceWith(s.innerHTML) : void 0 === r && s.nodeType == Node.ELEMENT_NODE && g.node.isBlock(s) && "TABLE" != s.tagName && g.node.clearAttributes(s)
        ...
        function t(e, t) {
            ...
            if (g.selection.isCollapsed()) {
                ...
                for (var f = g.$el.find('.fr-marker[data-type="true"]').get(0).nextSibling; f.firstChild;) f = f.firstChild;
        ...
        function i(r, e) {
            ...
            function b(e) {
                var t = e.newlines;
                if (h.keep_array_indentation && _(f.mode)) for (n = 0; n < t; n += 1) A(0 < n); else if (h.max_preserve_newlines && t > h.max_preserve_newlines && (t = h.max_preserve_newlines), h.preserve_newlines && 1 < e.newlines) {
                    A();
            ...
            function o() {
                ...
                if ("`" === r || "'" === r || '"' === r || ("/" === r || _.e4x && "<" === r && y.slice(M - 1).match(/^<([-a-zA-Z:0-9_.]+|{[^{}]*}|!\[CDATA\[[\s\S]*?\]\])(\s+[-a-zA-Z:0-9_.]+\s*=\s*('[^']*'|"[^"]*"|{.*?}))*\s*(\/?)\s*>/)) && ("TK_RESERVED" === t.type && G(t.text, ["return", "case", "throw", "else", "do", "typeof", "yield"]) || "TK_END_EXPR" === t.type && ")" === t.text && t.parent && "TK_RESERVED" === t.parent.type && G(t.parent.text, ["if", "while", "for"]) || G(t.type, ["TK_COMMENT", "TK_START_EXPR", "TK_START_BLOCK", "TK_END_BLOCK", "TK_OPERATOR", "TK_EQUALS", "TK_EOF", "TK_SEMICOLON", "TK_COMMA"]))) {
                    ...
                    if (e = r, "/" === c) for (var u = !1; M < $ && (f || u || y.charAt(M) !== c) && !Y.newline.test(y.charAt(M));) e += y.charAt(M), f ? f = !1 : (f = "\\" === y.charAt(M), "[" === y.charAt(M) ? u = !0 : "]" === y.charAt(M) && (u = !1)), M += 1; else if (_.e4x && "<" === c) {
                        ...
                        if (m && 0 === m.index) {
                            for (var v = m[2], E = 0; m;) {
                                var b = !!m[1], T = m[2], A = !!m[m.length - 1] || "![CDATA[" === T.slice(0, 8);
    ...
    if (Ee.FE.PLUGINS.colors = function (g) {
        ...
        function o(e) {
            var t = g.popups.get("colors.picker"),
                ...
                r = t.find(".fr-color-hex-layer input"), i = t.find('.fr-colors-tab[data-param1="' + e + '"]');
        ...
        function i(e) {
            var t, n;
            d.$el.attr("contenteditable", !0);
            for (var r = 0; r < Ee.FE.INSTANCES.length; r++) if ((t = Ee.FE.INSTANCES[r].$el.find(".fr-dragging")).length) {
                n = Ee.FE.INSTANCES[r];
                break
            }
            if (t.length) {
        ...
        var r, c = "https://i.froala.com/upload", l = 2, f = 3, p = 4, u = 5, h = 6, n = {};
        ...
        function v(e) {
            ...
            try {
                if (d.opts.fileUploadToS3) if (201 == t) {
                    var a = function (e) {
                        try {
                    ...
                    a && m(a, e, n || r)
                } else T(p, n || r); else if (200 <= t && t < 300) {
                    var o = function (e) {
                        try {
        ...
        function o(e) {
            if (void 0 !== e && 0 < e.length) {
                ...
                var t, n = e[0];
                if ((null === d.opts.fileUploadURL || d.opts.fileUploadURL == c) && !d.opts.fileUploadToS3) return s = n, (l = new FileReader).addEventListener("load", function () {
                    for (var e = l.result, t = atob(l.result.split(",")[1]), n = [], r = 0; r < t.length; r++) n.push(t.charCodeAt(r));
                    e = window.URL.createObjectURL(new Blob([new Uint8Array(n)], {type: s.type})), d.file.insert(e, s.name, null)
        ...
        function S() {
            var e, t = Array.prototype.slice.call(d.el.querySelectorAll("a.fr-file")), n = [];
            for (e = 0; e < t.length; e++) n.push(t[e].getAttribute("href"));
            if (r) for (e = 0; e < r.length; e++) n.indexOf(r[e].getAttribute("href")) < 0 && d.events.trigger("file.unlink", [r[e]]);
            r = t
        }
        ...
        return n[1] = "File cannot be loaded from the passed link.", n[l] = "No link in upload response.", n[f] = "Error during file upload.", n[p] = "Parsing response failed.", n[u] = "File is too large.", n[h] = "File file type is invalid.", n[7] = "Files can be uploaded only to same domain in IE 8 and IE 9.", {
            _init: function () {
                d.events.on("drop", t), d.events.$on(d.$win, "keydown", function (e) {
                    var t = e.which, n = d.popups.get("file.insert");
                ...
                var e = d.$tb.find('.fr-command[data-cmd="insertFile"]'), t = d.popups.get("file.insert");
            ...
            }, upload: o, insert: m, back: function () {
        ...
        var f, l, d, p, s, n, u = "https://i.froala.com/upload", t = !1, r = 1, h = 2, g = 3, m = 4, v = 5, E = 6,
            i = {};
        ...
        function a() {
            ...
            if (e || (e = x()), e) {
                ...
                f.hasClass("fr-uploading") ? w() : c.popups.show("image.edit", n, r, t.outerHeight())
            }
        }
        ...
        function C() {
            if (l || function () {
                ...
                c.shared.$image_resizer ? (l = c.shared.$image_resizer, p = c.shared.$img_overlay, c.events.on("destroy", function () {
                    ...
                    e.stopPropagation()
                }, !0), c.opts.imageResize && (l.append(o("nw") + o("ne") + o("sw") + o("se")), c.shared.$img_overlay = Ee('<div class="fr-image-overlay"></div>'), p = c.shared.$img_overlay, e = l.get(0).ownerDocument, Ee(e).find("body:first").append(p)));
                c.events.on("shared.destroy", function () {
                    ...
                    f && !f.hasClass("fr-uploading") ? oe(!0) : f && (C(), ue(), w(!1))
                });
        ...
        function y(e) {
            ...
            if (d && f) {
                ...
                C(), c.events.trigger("image.resize", [ge()])
            }
        }
        ...
        function _(e) {
            ...
            if (d && f) {
                ...
                d = null, p.hide(), C(), a(), c.undo.saveStep(), c.events.trigger("image.resizeEnd", [ge()])
            }
        }
        ...
        function x(e) {
            if (e) return c.$wp && c.events.$on(c.$wp, "scroll.image-edit", function () {
        ...
        function k(o, e, s, l, d) {
            ...
            t.onload = function () {
                ...
                if (l) {
                    ...
                    e.on("load", D), e.attr("src", o), c.edit.on(), A(!1), c.undo.saveStep(), c.events.disableBlur(), c.$el.blur(), c.events.trigger(n ? "image.replaced" : "image.inserted", [e, d])
                } else e = B(o, s, D), A(!1), c.undo.saveStep(), c.events.disableBlur(), c.$el.blur(), c.events.trigger("image.inserted", [e, d])
            }, t.onerror = function () {
                L(r)
            }, w(c.language.translate("Loading image")), t.src = o
        }
        ...
        function F(e) {
            ...
            try {
                if (c.opts.imageUploadToS3) if (201 == t) {
                    ...
                    a && k(a, !1, [], e, n || r)
                } else L(m, n || r, e); else if (200 <= t && t < 300) {
                    var o = function (e) {
                        try {
        ...
        function B(e, t, n) {
            ...
            ce(o, c.opts.imageDefaultDisplay, c.opts.imageDefaultAlign), o.on("load", n), o.on("error", n), c.edit.on(), c.events.focus(!0), c.selection.restore(), c.undo.saveStep(), c.opts.imageSplitHTML ? c.markers.split() : c.markers.insert(), c.html.wrap();
        ...
        function U(e, t) {
            if (void 0 !== e && 0 < e.length) {
                ...
                var n, r = e[0];
                if ((null === c.opts.imageUploadURL || c.opts.imageUploadURL == u) && !c.opts.imageUploadToS3) return o = r, s = t || f, (l = new FileReader).addEventListener("load", function () {
                    var e = l.result;
                    if (l.result.indexOf("svg+xml") < 0) {
                        for (var t = atob(l.result.split(",")[1]), n = [], r = 0; r < t.length; r++) n.push(t.charCodeAt(r));
                        e = window.URL.createObjectURL(new Blob([new Uint8Array(n)], {type: o.type})), c.image.insert(e, !1, null, s)
                    }
                }, !1), w(), l.readAsDataURL(o), !1;
                if (r.name || (r.name = (new Date).getTime() + "." + (r.type || "image/jpeg").replace(/image\//g, "")), r.size > c.opts.imageMaxSize) return L(v), !1;
                if (c.opts.imageAllowedTypes.indexOf(r.type.replace(/image\//g, "")) < 0) return L(E), !1;
                if (c.drag_support.formdata && (n = c.drag_support.formdata ? new FormData : null), n) {
                    ...
                    c.opts.imageUploadToS3 && (a = c.opts.imageUploadToS3.uploadURL ? c.opts.imageUploadToS3.uploadURL : "https://" + c.opts.imageUploadToS3.region + ".amazonaws.com/" + c.opts.imageUploadToS3.bucket), function (t, n, e, i) {
                        function a() {
                            var e = Ee(this);
                            e.off("load"), e.addClass("fr-uploading"), e.next().is("br") && e.next().remove(), c.placeholder.refresh(), I(e), C(), w(), c.edit.off(), t.onload = function () {
                                F.call(t, e)
                        ...
                        o.addEventListener("load", function () {
                            ...
                            i ? (i.on("load", a), i.one("error", a), c.edit.on(), c.undo.saveStep(), i.data("fr-old-src", i.attr("src")), i.attr("src", e)) : B(e, null, a)
                        }, !1), o.readAsDataURL(e)
        ...
        function H(e) {
            ...
            if (t && t.files && t.files.length) {
                ...
                if (n && n.type && -1 !== n.type.indexOf("image") && 0 <= c.opts.imageAllowedTypes.indexOf(n.type.replace(/image\//g, ""))) {
                    ...
                    return c.opts.iframe && (a += c.$iframe.offset().top, i += c.$iframe.offset().left), c.popups.show("image.insert", i, a), w(), 0 <= c.opts.imageAllowedTypes.indexOf(n.type.replace(/image\//g, "")) ? (oe(!0), U(t.files)) : L(E), e.preventDefault(), e.stopPropagation(), !1
                }
            }
        }

        function W(e) {
            if (e) return c.popups.onRefresh("image.insert", b), c.popups.onHide("image.insert", T), !0;
            var t, n = "";
        ...
        function Y() {
            ...
            e || (e = G()), N(), c.popups.refresh("image.alt"), c.popups.setContainer("image.alt", c.$sc);
            var t = me();
        ...
        function V() {
            ...
            } else e.find('input[name="width"]').val(f.get(0).style.width).trigger("change"), e.find('input[name="height"]').val(f.get(0).style.height).trigger("change")
        }

        function X() {
            var e = c.popups.get("image.size");
            e || (e = q()), N(), c.popups.refresh("image.size"), c.popups.setContainer("image.size", c.$sc);
            var t = me();
            ve() && (t = t.find(".fr-img-wrap"));
            var n = t.offset().left + t.outerWidth() / 2, r = t.offset().top + t.outerHeight();
        ...
        function Q(e) {
            (e = e || me()) && !1 !== c.events.trigger("image.beforeRemove", [e]) && (c.popups.hideAll(), he(), oe(!0), c.undo.canDo() || c.undo.saveStep(), e.get(0) == c.el ? e.removeAttr("src") : (e.get(0).parentNode && "A" == e.get(0).parentNode.tagName ? (c.selection.setBefore(e.get(0).parentNode) || c.selection.setAfter(e.get(0).parentNode) || e.parent().after(Ee.FE.MARKERS), Ee(e.get(0).parentNode).remove()) : (c.selection.setBefore(e.get(0)) || c.selection.setAfter(e.get(0)) || e.after(Ee.FE.MARKERS), e.remove()), c.html.fillEmptyBlocks(), c.selection.restore()), c.undo.saveStep())
        }
        ...
        function ee(e) {
            ...
            f = Ee(e), C(), a(), ue(), w(), f.one("load", function () {
                C(), w()
            });
            for (var t = atob(Ee(e).attr("src").split(",")[1]), n = [], r = 0; r < t.length; r++) n.push(t.charCodeAt(r));
            U([new Blob([new Uint8Array(n)], {type: Ee(e).attr("src").split(",")[0].replace(/data\:/g, "").replace(/;base64/g, "")})], f)
        }
        ...
        function re(e) {
            if (e && e.clipboardData && e.clipboardData.items) {
                var t = null;
                if (e.clipboardData.getData("text/rtf")) t = e.clipboardData.items[0].getAsFile(); else for (var n = 0; n < e.clipboardData.items.length && !(t = e.clipboardData.items[n].getAsFile()); n++) ;
        ...
        function ae(e) {
            ...
            c.toolbar.disable(), e && (e.stopPropagation(), e.preventDefault()), c.helpers.isMobile() && (c.events.disableBlur(), c.$el.blur(), c.events.enableBlur()), c.opts.iframe && c.size.syncIframe(), f = Ee(this), he(), C(), a(), c.popups.areVisible() && c.events.disableBlur(), c.win.getSelection ? (c.win.getSelection().removeAllRanges(), c.win.getSelection().addRange(c.doc.createRange())) : c.selection.clear(), c.helpers.isIOS() && (c.events.disableBlur(), c.$el.blur()), c.button.bulkRefresh(), c.events.trigger("video.hideResizer")
        }
        ...
        function ue() {
            ...
            e || (e = W()), c.popups.isVisible("image.insert") || (N(), c.popups.refresh("image.insert"), c.popups.setContainer("image.insert", c.$sc));
            var t = me();
            ve() && (t = t.find(".fr-img-wrap"));
            var n = t.offset().left + t.outerWidth() / 2, r = t.offset().top + t.outerHeight();
        ...
        return {
            _init: function () {
                ...
                c.events.$on(c.$el, c._mousedown, "IMG" == c.el.tagName ? null : 'img:not([contenteditable="false"])', function (e) {
                ...
                }, !0), c.events.on("drop", H), c.events.on("element.beforeDrop", K), c.events.on("mousedown window.mousedown", le), c.events.on("window.touchmove", de), c.events.on("mouseup window.mouseup", function () {
                    if (f) return oe(), !1;
                    de()
                    ...
                    e.nodeType === Node.TEXT_NODE && (e = e.parentNode), c.node.hasClass(e, "fr-inner") || (c.node.hasClass(e, "fr-img-caption") || (e = Ee(e).parents(".fr-img-caption").get(0)), Ee(e).after(Ee.FE.INVISIBLE_SPACE + Ee.FE.MARKERS), c.selection.restore())
                })) : c.events.$on(c.$win, "keydown", Z), c.events.on("toolbar.esc", function () {
                    if (f) {
                ...
                }), c.opts.iframe && c.events.on("image.loaded", c.size.syncIframe), c.$wp && (A(), c.events.on("contentChanged", A)), c.events.$on(Ee(c.o_win), "orientationchange.image", function () {
                    setTimeout(function () {
                        f && I(f)
                    }, 100)
            ...
            showInsertPopup: function () {
                ...
                if (t || (t = W()), N(), !t.hasClass("fr-active")) if (c.popups.refresh("image.insert"), c.popups.setContainer("image.insert", c.$tb), e.is(":visible")) {
                    var n = e.offset().left + e.outerWidth() / 2,
            ...
            insertByURL: function () {
                var e = c.popups.get("image.insert").find(".fr-image-by-url-layer input");
                if (0 < e.val().length) {
                    w(), O(c.language.translate("Loading image"));
                    var t = e.val().trim();
                    if (c.opts.imageUploadRemoteUrls && c.opts.imageCORSProxy && c.opts.imageUpload) {
                        var n = new XMLHttpRequest;
                        n.onload = function () {
                            200 == this.status ? U([new Blob([this.response], {type: this.response.type || "image/png"})], f) : L(r)
                        }, n.onerror = function () {
                            k(t, !0, [], f)
            ...
            align: function (e) {
                var t = me();
                t.removeClass("fr-fir fr-fil"), !c.opts.htmlUntouched && c.opts.useClasses ? "left" == e ? t.addClass("fr-fil") : "right" == e && t.addClass("fr-fir") : ce(t, pe(), e), he(), C(), a(), c.selection.clear()
            },
            ...
            display: function (e) {
                var t = me();
                t.removeClass("fr-dii fr-dib"), !c.opts.htmlUntouched && c.opts.useClasses ? "inline" == e ? t.addClass("fr-dii") : "block" == e && t.addClass("fr-dib") : ce(t, e, fe()), he(), C(), a(), c.selection.clear()
            },
            ...
            setSize: function (e, t) {
                if (f) {
                    ...
                    var r = /^[\d]+((px)|%)*$/g;
                    f.removeAttr("width").removeAttr("height"), e.match(r) ? f.css("width", e) : f.css("width", ""), t.match(r) ? f.css("height", t) : f.css("height", ""), ve() && (f.parent().removeAttr("width").removeAttr("height"), e.match(r) ? f.parent().css("width", e) : f.parent().css("width", ""), t.match(r) ? f.parent().css("height", t) : f.parent().css("height", "")), n && n.find("input:focus").blur(), I(f)
                }
            },
            toggleCaption: function () {
                ...
                if (f && !ve()) {
                    ...
                    var t = e.width();
                    e.wrap("<span " + (c.browser.mozilla ? "" : 'contenteditable="false"') + 'class="fr-img-caption ' + f.attr("class") + '" draggable="false"></span>'), e.wrap('<span class="fr-img-wrap"></span>'), e.after('<span class="fr-inner"' + (c.browser.mozilla ? "" : ' contenteditable="true"') + ">" + Ee.FE.START_MARKER + "Image caption" + Ee.FE.END_MARKER + "</span>"), f.removeAttr("class").removeAttr("style").removeAttr("width"), f.parents(".fr-img-caption").css("width", t + "px"), oe(!0), c.selection.restore()
                } else e = me(), f.insertAfter(e), f.attr("class", e.attr("class").replace("fr-img-caption", "")).attr("style", e.attr("style")), e.remove(), I(f)
            },
            hasCaption: ve,
            exitEdit: oe,
            edit: I
        ...
        function I(e) {
            ...
            confirm(t) && (s.opts.imageManagerDeleteURL ? !1 !== s.events.trigger("imageManager.beforeDeleteImage", [n]) && (n.parent().addClass("fr-image-deleting"), Ee.ajax({
                ...
                data: Ee.extend(Ee.extend({src: n.attr("src")}, N(n)), s.opts.imageManagerDeleteParams),
    ...
    Ee.FE.DEFAULTS.imageInsertButtons.push("imageManager"), Ee.FE.RegisterCommand("imageManager", {
        ...
        return {
            apply: function (e) {
                ...
                t.find(".fr-command").each(function () {
                    var e = Ee(this).data("param1"), t = n.format.is("span", {"class": e});
                    Ee(this).toggleClass("fr-active", t).attr("aria-selected", t)
                })
            }
        }
    ...
    }), Ee.FE.DefineIcon("inlineClass", {NAME: "tag"}), Ee.extend(Ee.FE.DEFAULTS, {
        inlineStyles: {
        ...
        plugin: "link"
    }), Ee.extend(Ee.FE.DEFAULTS, {listAdvancedTypes: !0}), Ee.FE.PLUGINS.lists = function (f) {
        function p(e) {
    ...
    }), Ee.FE.DefineIcon("paragraphStyle", {NAME: "magic"}), Ee.extend(Ee.FE.DEFAULTS, {html2pdf: window.html2pdf}), Ee.FE.PLUGINS.print = function (s) {
        return {
            run: function () {
                !function (e) {
                    var t = s.$el.html(), n = null;
    ...
    }, Ee.FE.DefineIcon("save", {NAME: "floppy-o", FA5NAME: "save"}), Ee.FE.RegisterCommand("save", {
        title: "Save",
        undo: !1,
        focus: !1,
        refreshAfterCallback: !1,
        ...
        function u() {
            ...
            if (e) {
                ...
                if (t || (t = p()), t) {
                    ...
                    var n = N(e), r = (n.left + n.right) / 2, i = n.bottom;
        ...
        function d() {
            ...
            if (i) {
                ...
                var o = N(i), s = (o.left + o.right) / 2, l = o.bottom;
        ...
        function N(e) {
            var t = w(e), n = Ee(e[t.min_i][t.min_j]), r = Ee(e[t.min_i][t.max_j]), i = Ee(e[t.max_i][t.min_j]);
            return {
                left: n.offset().left,
                    ...
                    T.opts.iframe && (t -= T.$iframe.offset().left), A.data("release-position", t), A.removeData("max-left"), A.removeData("max-right"), function () {
                        ...
                        if (e !== t) {
                            ...
                            if (T.undo.canDo() || T.undo.saveStep(), null !== n && null !== r) {
                                ...
                                for (o = 0; o < d.length; o++) if (s = Ee(d[o][n]), l = Ee(d[o][r]), d[o][n] != d[o][r]) {
        ...
        return {
            _init: function () {
                ...
                if (1 < Q().length && (0 === T.$el.find("th.fr-selected-cell").length || 0 === T.$el.find("td.fr-selected-cell").length)) {
                    _();
                    var e, t, n = w(S()), r = T.$el.find(".fr-selected-cell"), i = Ee(r[0]),
        ...
        function n() {
            var t = a.selection.ranges(0), n = t.startContainer;
        ...
        var s, c, p, u, r, n, l = "https://i.froala.com/upload", d = 2, h = 3, g = 4, m = 5, v = 6, i = {};
        ...
        function o(e) {
            if (e) return f.popups.onRefresh("video.insert", E), f.popups.onHide("image.insert", V), !0;
            var t = "";
        ...
        function N(e) {
            ...
            f.undo.canDo() || f.undo.saveStep(), (c = Ee(this)).data("start-x", t), c.data("start-y", n), s.show(), f.popups.hideAll(), B()
        }
        ...
        function F() {
            p || function () {
                ...
                if (f.shared.$video_resizer ? (p = f.shared.$video_resizer, s = f.shared.$vid_overlay, f.events.on("destroy", function () {
                    ...
                    e = p.get(0).ownerDocument, f.events.$on(p, f._mousedown, ".fr-handler", N), f.events.$on(Ee(e), f._mousemove, O), f.events.$on(Ee(e.defaultView || e.parentWindow), f._mouseup, I), f.events.$on(s, "mouseleave", I);
                    var r = 1, i = null, a = 0;
                    f.events.on("keydown", function (e) {
                        if (u) {
                            var t = -1 != navigator.userAgent.indexOf("Mac OS X") ? e.metaKey : e.ctrlKey, n = e.which;
                            (n !== i || 200 < e.timeStamp - a) && (r = 1), (n == Ee.FE.KEYCODE.EQUALS || f.browser.mozilla && n == Ee.FE.KEYCODE.FF_EQUALS) && t && !e.altKey ? r = D.call(this, e, 1, 1, r) : (n == Ee.FE.KEYCODE.HYPHEN || f.browser.mozilla && n == Ee.FE.KEYCODE.FF_HYPHEN) && t && !e.altKey && (r = D.call(this, e, 2, -1, r)), i = n, a = e.timeStamp
                        }
        ...
        function M(e) {
            ...
            f.toolbar.disable(), f.helpers.isMobile() && (f.events.disableBlur(), f.$el.blur(), f.events.enableBlur()), f.$el.find(".fr-video.fr-active").removeClass("fr-active"), (u = Ee(this)).addClass("fr-active"), f.opts.iframe && f.size.syncIframe(), j(), F(), a(), f.selection.clear(), f.button.bulkRefresh(), f.events.trigger("image.hideResizer")
        }
        ...
        function U(e) {
            if (void 0 !== e && 0 < e.length) {
                ...
                var t, n = e[0];
                if ((null === f.opts.videoUploadURL || f.opts.videoUploadURL == l) && !f.opts.videoUploadToS3) return function (r) {
                    u && u.find("iframe") && u.find("iframe").length && G();
                    var i = new FileReader;
                    i.addEventListener("load", function () {
                        i.result;
                        for (var e = atob(i.result.split(",")[1]), t = [], n = 0; n < e.length; n++) t.push(e.charCodeAt(n));
                        A(window.URL.createObjectURL(new Blob([new Uint8Array(t)], {type: r.type})), !1, null, u)
                    }, !1), C(), i.readAsDataURL(r)
                }(n), !1;
                if (n.size > f.opts.videoMaxSize) return K(m), !1;
                if (f.opts.videoAllowedTypes.indexOf(n.type.replace(/video\//g, "")) < 0) return K(v), !1;
        ...
        function W(e) {
            if (e) return f.popups.onRefresh("video.size", H), !0;
            var t = {
        ...
        return i[1] = "Video cannot be loaded from the passed link.", i[d] = "No link in upload response.", i[h] = "Error during file upload.", i[g] = "Parsing response failed.", i[m] = "File is too large.", i[v] = "Video file type is invalid.", i[7] = "Files can be uploaded only to same domain in IE 8 and IE 9.", f.shared.vid_exit_flag = !1, {
            _init: function () {
                f.opts.videoResponsive && (f.opts.videoResize = !1), f.events.on("drop", P, !0), f.events.on("mousedown window.mousedown", e), f.events.on("window.touchmove", B), f.events.on("mouseup window.mouseup", $), f.events.on("commands.mousedown", function (e) {
                    ...
                    var t = e.which;
                    return !u || t != Ee.FE.KEYCODE.BACKSPACE && t != Ee.FE.KEYCODE.DELETE ? u && t == Ee.FE.KEYCODE.ESC ? ($(!0), e.preventDefault(), !1) : u && t != Ee.FE.KEYCODE.F10 && !f.keys.isBrowserAction(e) ? (e.preventDefault(), !1) : void 0 : (e.preventDefault(), G(), f.undo.saveStep(), !1)
                ...
                if (t || (t = o()), S(), !t.hasClass("fr-active")) if (f.popups.refresh("video.insert"), f.popups.setContainer("video.insert", f.$tb), e.is(":visible")) {
                    var n = e.offset().left + e.outerWidth() / 2,
                        r = e.offset().top + (f.opts.toolbarBottom ? 10 : e.outerHeight() - 10);
            ...
            }, upload: U, insertByURL: function (e) {
                ...
                void 0 === e && (e = f.popups.get("video.insert").find(".fr-video-embed-layer textarea").val() || ""), 0 !== e.length && Ee.FE.VIDEO_EMBED_REGEX.test(e) ? b(e) : f.events.trigger("video.codeError", [e])
            ...
            }, remove: G, hideProgressBar: S, showSizePopup: function () {
