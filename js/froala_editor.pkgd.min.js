...
!function (n) {
  ...
  s.DEFAULTS = {
    ...
    for (var t in e) if (e.hasOwnProperty(t)) {
      if (this[t]) continue;
      if (be.FE.PLUGINS[t] && this.opts.pluginsEnabled.indexOf(t) < 0) continue;
    ...
    if (this.opts.iframe && (this.events.disableBlur(), this.win.focus(), this.events.enableBlur()), this.events.trigger("destroy", [], !0), this.events.trigger("shared.destroy", undefined, !0), 0 === this.shared.count) {
      for (var t in this.shared) this.shared.hasOwnProperty(t) && (this.shared[t], be.FE.SHARED[this.sid][t] = null);
    ...
    if ("string" == typeof i) {
      ...
      return this.each(function () {
        ...
        if (e) {
          var t, n;
          if (0 < i.indexOf(".") && e[i.split(".")[0]] ? (e[i.split(".")[0]] && (t = e[i.split(".")[0]]), n = i.split(".")[1]) : (t = e, n = i.split(".")[0]), !t[n]) return be.error("Method " + i + " does not exist in Froala Editor.");
  ...
  if (be.FE.LinkRegExCommon = "[a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_.]{1,}", be.FE.LinkRegExEnd = "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;/~+#-\\'*-_{}]*)|())", be.FE.LinkRegExTLD = "((" + be.FE.LinkRegExCommon + ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))", be.FE.LinkRegExHTTP = "((ftp|http|https):\\/\\/" + be.FE.LinkRegExCommon + ")", be.FE.LinkRegExAuth = "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@" + be.FE.LinkRegExCommon + ")", be.FE.LinkRegExWWW = "(www\\." + be.FE.LinkRegExCommon + "\\.[a-z0-9-]{2,24})", be.FE.LinkRegEx = "(" + be.FE.LinkRegExTLD + "|" + be.FE.LinkRegExHTTP + "|" + be.FE.LinkRegExWWW + "|" + be.FE.LinkRegExAuth + ")" + be.FE.LinkRegExEnd, be.FE.LinkProtocols = ["mailto", "tel", "sms", "notes", "data"], be.FE.MAIL_REGEX = /.+@.+\..+/i, be.FE.MODULES.helpers = function (a) {
    ...
    return {
      _init: function () {
        s.shared.$_events = s.shared.$_events || [], s.shared._events = {}, s.helpers.isMobile() ? (s._mousedown = "touchstart", s._mouseup = "touchend", s._move = "touchmove", s._mousemove = "touchmove") : (s._mousedown = "mousedown", s._mouseup = "mouseup", s._move = "", s._mousemove = "mousemove"), t(s.$el, "click mouseup mousedown touchstart touchend dragenter dragover dragleave dragend drop dragstart", function (e) {
          ...
          for (var e = 0; e < be.FE.INSTANCES.length; e++) be.FE.INSTANCES[e] != s && be.FE.INSTANCES[e].popups && be.FE.INSTANCES[e].popups.areVisible() && be.FE.INSTANCES[e].$el.find(".fr-marker").remove()
    ...
    return {
      isBlock: l, isEmpty: function (e, t) {
        ...
        if (void 0 === t && (t = []), void 0 === n && (n = !0), t.push(o.el), 0 <= t.indexOf(e.parentNode) || e.parentNode && o.node.hasClass(e.parentNode, "fr-inner") || e.parentNode && 0 <= be.FE.SIMPLE_ENTER_TAGS.indexOf(e.parentNode.tagName) && n) return null;
        for (; t.indexOf(e.parentNode) < 0 && e.parentNode && !o.node.hasClass(e.parentNode, "fr-inner") && (be.FE.SIMPLE_ENTER_TAGS.indexOf(e.parentNode.tagName) < 0 || !n) && (!l(e) || !l(e.parentNode) || !n);) e = e.parentNode;
        return e
    ...
    function l() {
      ...
      try {
        ...
        if (n.insertNode(i), i = d.$el.find("span.fr-marker").get(0)) {
          for (var a = i.nextSibling; a && a.nodeType === Node.TEXT_NODE && 0 === a.textContent.length;) be(a).remove(), a = d.$el.find("span.fr-marker").get(0).nextSibling;
    ...
    function S() {
      if (T.$wp) {
        ...
        for (t = 0; t < n.length; t++) if (n[t].startContainer !== T.doc || T.browser.msie) {
          ...
          if (void 0 !== a && a || !i || (be(".fr-marker").remove(), T.selection.setAtEnd(T.el)), T.el.normalize(), T.browser.safari && !i) try {
    ...
    function R() {
      ...
      for (e = 0; e < t.length; e++) {
        var r = be(t[e]).data("id"), i = t[e], a = T.doc.createRange(),
        ...
        if (0 < o.length) {
          o = o[0];
          try {
            for (var l, d = !1, c = i.nextSibling; c && c.nodeType == Node.TEXT_NODE && 0 === c.textContent.length;) c = (l = c).nextSibling, be(l).remove();
            for (var f, p, u = o.nextSibling; u && u.nodeType == Node.TEXT_NODE && 0 === u.textContent.length;) u = (l = u).nextSibling, be(l).remove();
            if (i.nextSibling == o || o.nextSibling == i) {
              for (var h = i.nextSibling == o ? i : o, g = h == i ? o : i, m = h.previousSibling; m && m.nodeType == Node.TEXT_NODE && 0 === m.length;) m = (l = m).previousSibling, be(l).remove();
              if (m && m.nodeType == Node.TEXT_NODE) for (; m && m.previousSibling && m.previousSibling.nodeType == Node.TEXT_NODE;) m.previousSibling.textContent = m.previousSibling.textContent + m.textContent, m = m.previousSibling, be(m.nextSibling).remove();
              for (var v = g.nextSibling; v && v.nodeType == Node.TEXT_NODE && 0 === v.length;) v = (l = v).nextSibling, be(l).remove();
              if (v && v.nodeType == Node.TEXT_NODE) for (; v && v.nextSibling && v.nextSibling.nodeType == Node.TEXT_NODE;) v.nextSibling.textContent = v.textContent + v.nextSibling.textContent, v = v.nextSibling, be(v.previousSibling).remove();
            ...
            if (!d) (T.browser.chrome || T.browser.edge) && i.nextSibling == o ? (f = y(o, a, !0) || a.setStartAfter(o), p = y(i, a, !1) || a.setEndBefore(i)) : (i.previousSibling == o && (o = (i = o).nextSibling), o.nextSibling && "BR" === o.nextSibling.tagName || !o.nextSibling && T.node.isBlock(i.previousSibling) || i.previousSibling && "BR" == i.previousSibling.tagName || (i.style.display = "inline", o.style.display = "inline", s = be(T.doc.createTextNode("\u200b"))), f = y(i, a, !0) || be(i).before(s) && a.setStartBefore(i), p = y(o, a, !1) || be(o).after(s) && a.setEndAfter(o)), "function" == typeof f && f(), "function" == typeof p && p()
          } catch (b) {
          }
        }
        s && s.remove();
    ...
    function L(e, t) {
      ...
      for (var r = T.node.contents(e), i = 0; i < r.length; i++) r[i].nodeType != Node.ELEMENT_NODE ? be(r[i]).remove() : (L(r[i], 0 === i), 0 === i && (t = !1));
    ...
    return {
      text: s, get: A, ranges: c, clear: C, element: function () {
        ...
        for (e = 0; e < t.length; e++) t[e].nextSibling && (t[e].innerHTML = '<span class="fr-mk">' + be.FE.INVISIBLE_SPACE + "</span>" + t[e].innerHTML);
        var n = !1, r = i(T.el);
        ...
        for (t = 0; t < i.length; t++) for (var a = i[t]; !(n(a) || T.node.isBlock(a.parentNode) || T.$el.is(a.parentNode) || T.node.hasClass(a.parentNode, "fr-inner"));) be(a.parentNode).before(a);
        var o = T.$el.find('.fr-marker[data-type="false"]');
        for (t = 0; t < o.length; t++) {
          for (var s = o[t]; !(r(s) || T.node.isBlock(s.parentNode) || T.$el.is(s.parentNode) || T.node.hasClass(s.parentNode, "fr-inner"));) be(s.parentNode).after(s);
        ...
        if (function () {
          for (var e = T.$el.find(".fr-marker"), t = 0; t < e.length; t++) if (be(e[t]).parentsUntil('.fr-element, [contenteditable="true"]', '[contenteditable="false"]').length) return !1;
          return !0
        }()) {
          !function e(t, n) {
          ...
          if (l.length) T.$el.find(".fr-marker").remove(), l.append(be.FE.INVISIBLE_SPACE + be.FE.MARKERS).removeAttr("data-first"), l.attr("data-text") && l.replaceWith(l.html()); else for (T.$el.find("table").filter(function () {
            ...
            if (f) {
              if (d && (!c || c != f)) {
                ...
                if (p && 0 <= ["UL", "OL"].indexOf(p.tagName) && (h = !(p = null)), u && 0 <= ["UL", "OL"].indexOf(u.tagName) && (g = !(u = null)), be(d).after(f), p != u) if (null != p || h) if (null != u || g || 0 !== be(p).parentsUntil(T.$el, "table").length) p && u && 0 === be(p).parentsUntil(T.$el, "table").length && 0 === be(u).parentsUntil(T.$el, "table").length && 0 === be(p).find(u).length && 0 === be(u).find(p).length && (be(p).append(be(u).html()), be(u).remove()); else {
            ...
            } else f = be(d).clone().attr("data-type", !1), be(d).after(f)
          }
        }
        ...
        for (e = t.length - 1; 0 < e; e--) be(t[e]).find(t).length && t.splice(e, 1);
        return t
    ...
    htmlUntouched: !1,
    fullPage: !1
  }), be.FE.HTML5Map = {B: "STRONG", I: "EM", STRIKE: "S"}, be.FE.MODULES.clean = function (c) {
    var f, p, u, h;
    ...
    function E(e) {
      ...
      !function (e) {
        ...
        if (e.nodeType == Node.ELEMENT_NODE && be.FE.HTML5Map[e.tagName] && "" === c.node.attributes(e)) {
          var r = be.FE.HTML5Map[e.tagName], i = "<" + r + ">" + e.innerHTML + "</" + r + ">";
    ...
    return {
      _init: function () {
        ...
        var i, a = be.merge([], c.opts.htmlAllowedTags);
        ...
        if (e.length) {
          ...
          for (var n = 0; n < e.length; n++) "" === c.node.attributes(e[n]) && be(e[n]).replaceWith("<" + be.FE.HTML5Map[e[n].tagName] + ">" + e[n].innerHTML + "</" + be.FE.HTML5Map[e[n].tagName] + ">");
        ...
        !function () {
          ...
          for (var e = c.el.querySelectorAll("ul, ol"), t = 0; t < e.length; t++) for (var n = c.node.contents(e[t]), r = null, i = n.length - 1; 0 <= i; i--) "LI" != n[i].tagName ? (r || (r = be("<li>")).insertBefore(n[i]), r.prepend(n[i])) : r = null
        }(), function () {
          var e, t, n;
          do {
            t = !1;
          ...
          for (var e = c.el.querySelectorAll("li > ul, li > ol"), t = 0; t < e.length; t++) {
            var n = e[t];
            if (c.node.isFirstSibling(n)) be(n).before("<br/>"); else if (n.previousSibling && "BR" == n.previousSibling.tagName) {
          ...
          for (var e = c.el.querySelectorAll("li:empty"), t = 0; t < e.length; t++) be(e[t]).remove()
        }()
    ...
    function r(e, t) {
      ...
      if (!l.html.isPreformatted(a)) {
        ...
        for (var o = "", s = 0; s < i.length; s++) 32 != i.charCodeAt(s) || 0 !== s && 32 != o.charCodeAt(s - 1) || n && r && l.node.isVoid(n) && l.node.isVoid(r) ? o += i[s] : o += be.FE.UNICODE_NBSP;
    ...
    function a(e) {
      ...
      var l = p();
      for (l += "," + be.FE.VOID_ELEMENTS.join(","), l += ", .fr-inner", l += "," + x.opts.htmlAllowedEmptyTags.join(":not(.fr-marker),") + ":not(.fr-marker)", t = r.length - 1; 0 <= t; t--) if (!(r[t].textContent && 0 < r[t].textContent.replace(/\u200B|\n/g, "").length || 0 < r[t].querySelectorAll(l).length)) {
    ...
    function e(e) {
      var t, n, r = be.merge([], be.FE.VOID_ELEMENTS);
    ...
    return {
      defaultTag: c, isPreformatted: s, emptyBlocks: a, emptyBlockTagsQuery: function () {
        ...
        if (x.node.isEmpty(x.el)) x.opts.fullPage && (n = w(x.iframe_document), n += "<html" + x.node.attributes(x.$html.get(0)) + ">" + x.$html.find("head").get(0).outerHTML + "<body></body></html>"); else if (void 0 === e && (e = !1), x.opts.fullPage) {
        ...
        var e, t, n = function (e, t) {
          for (; t && (t.nodeType == Node.TEXT_NODE || !x.node.isBlock(t)) && !x.node.isElement(t) && !x.node.hasClass(t, "fr-inner");) t && t.nodeType != Node.TEXT_NODE && be(e).wrapInner(x.node.openTagString(t) + x.node.closeTagString(t)), t = t.parentNode;
  ...
  }, be.extend(be.FE.DEFAULTS, {language: null}), be.FE.LANGUAGE = {}, be.FE.MODULES.language = function (e) {
    var t;
    return {
      _init: function () {
  ...
  }, be.extend(be.FE.DEFAULTS, {placeholderText: "Type something"}), be.FE.MODULES.placeholder = function (c) {
    function e() {
      c.$placeholder || (c.$placeholder = be('<span class="fr-placeholder"></span>'), c.$wp.append(c.$placeholder));
      var e = c.opts.iframe ? c.$iframe.prev().outerHeight(!0) : c.$el.prev().outerHeight(!0), t = 0, n = 0, r = 0,
        i = 0, a = 0, o = 0, s = c.node.contents(c.el), l = be(c.selection.element()).css("text-align");
    ...
    return {
      _startEnter: function (e) {
        ...
        if (g.node.isEmpty(n, !0) && r) {
          ...
          var d = "";
          for (d = l.parentNode && "LI" == l.parentNode.tagName ? s + "<li>" + be.FE.MARKERS + "<br>" + o : a ? s + "<" + a + ">" + be.FE.MARKERS + "<br></" + a + ">" + o : s + be.FE.MARKERS + "<br>" + o; ["UL", "OL"].indexOf(l.tagName) < 0 || l.parentNode && "LI" === l.parentNode.tagName;) l = l.parentNode;
          ...
          t = v(n);
          for (var u = be.FE.MARKERS + "<br>", h = e.parentNode; h && "LI" != h.tagName;) u = g.node.openTagString(h) + u + g.node.closeTagString(h), h = h.parentNode;
          t.parentNode && "LI" == t.parentNode.tagName ? be(t.parentNode).after("<li>" + u + "</li>") : a ? be(t).after("<" + a + ">" + u + "</" + a + ">") : be(t).after(u), be(n).remove()
        } else (t = v(n)).parentNode && "LI" == t.parentNode.tagName ? r ? be(t.parentNode).before(g.node.openTagString(n) + be.FE.MARKERS + "<br></li>") : be(t.parentNode).after(g.node.openTagString(n) + be.FE.MARKERS + "<br></li>") : a ? be(t).before("<" + a + ">" + be.FE.MARKERS + "<br></" + a + ">") : be(t).before(be.FE.MARKERS + "<br>"), be(n).remove()
        ...
        if (n) {
          ...
          for (var i, a = g.node.contents(t)[0]; a && !g.node.isList(a);) i = a.nextSibling, be(n).append(a), a = i;
          for (n = t.previousSibling; a;) i = a.nextSibling, be(n).append(a), a = i;
        ...
        if (r) {
          ...
          for (var i, a = e, o = g.node.contents(r)[0]; o && !g.node.isList(o);) i = o.nextSibling, be(a).after(o), a = o, o = i;
          for (; o;) i = o.nextSibling, be(n).append(o), o = i;
          be(e).replaceWith(be.FE.MARKERS), be(r).remove()
        } else {
          for (var s = n; !s.nextSibling && s != g.el;) s = s.parentNode;
          if (s == g.el) return !1;
          if (s = s.nextSibling, g.node.isBlock(s)) be.FE.NO_DELETE_TAGS.indexOf(s.tagName) < 0 && (be(e).replaceWith(be.FE.MARKERS), (t = g.node.contents(n)).length && "BR" == t[t.length - 1].tagName && be(t[t.length - 1]).remove(), be(n).append(be(s).html()), be(s).remove()); else for ((t = g.node.contents(n)).length && "BR" == t[t.length - 1].tagName && be(t[t.length - 1]).remove(), be(e).replaceWith(be.FE.MARKERS); s && !g.node.isBlock(s) && "BR" != s.tagName;) be(n).append(be(s)), s = s.nextSibling
        }
      }
    }
    ...
    function c(e) {
      ...
      if (n = n.previousSibling, !u.node.isBlock(n) && u.node.isEditable(n)) {
        ...
        if (n.nodeType == Node.TEXT_NODE) {
          ...
          if (u.opts.tabSpaces && r.length >= u.opts.tabSpaces) 0 === r.substr(r.length - u.opts.tabSpaces, r.length - 1).replace(/ /g, "").replace(new RegExp(be.FE.UNICODE_NBSP, "g"), "").length && (i = r.length - u.opts.tabSpaces + 1);
          n.textContent = r.substring(0, i - d(r));
          var a = r.length != n.textContent.length;
          if (0 === n.textContent.length) if (a && u.opts.keepFormatOnDelete) be(n).after(be.FE.INVISIBLE_SPACE + be.FE.MARKERS); else if ((2 != n.parentNode.childNodes.length || n.parentNode != e.parentNode) && 1 != n.parentNode.childNodes.length || u.node.isBlock(n.parentNode) || u.node.isElement(n.parentNode) || !u.node.isDeletable(n.parentNode)) {
          ...
          } else be(n.parentNode).after(be.FE.MARKERS), be(n.parentNode).remove(); else be(n).after(be.FE.MARKERS)
        } else u.node.isDeletable(n) ? (be(n).after(be.FE.MARKERS), be(n).remove()) : e.nextSibling && "BR" == e.nextSibling.tagName && u.node.isVoid(n) && "BR" != n.tagName ? (be(e.nextSibling).remove(), be(e).replaceWith(be.FE.MARKERS)) : !1 !== u.events.trigger("node.remove", [be(n)]) && (be(n).after(be.FE.MARKERS), be(n).remove())
      } else if (be.FE.NO_DELETE_TAGS.indexOf(n.tagName) < 0 && (u.node.isEditable(n) || u.node.isDeletable(n))) if (u.node.isDeletable(n)) be(e).replaceWith(be.FE.MARKERS), be(n).remove(); else if (u.node.isEmpty(n) && !u.node.isList(n)) be(n).remove(), be(e).replaceWith(be.FE.MARKERS); else {
        for (u.node.isList(n) && (n = be(n).find("li:last").get(0)), (t = u.node.contents(n)) && "BR" == t[t.length - 1].tagName && be(t[t.length - 1]).remove(), t = u.node.contents(n); t && u.node.isBlock(t[t.length - 1]);) n = t[t.length - 1], t = u.node.contents(n);
      ...
      } else e.nextSibling && "BR" == e.nextSibling.tagName && be(e.nextSibling).remove()
    }

    function l(e) {
      var t = 0 < be(e).parentsUntil(u.$el, "BLOCKQUOTE").length, n = u.node.deepestParent(e, [], !t);
      ...
      if (null !== n) {
        ...
        if (u.node.isBlock(n) && (u.node.isEditable(n) || u.node.isDeletable(n)) && a && be.FE.NO_DELETE_TAGS.indexOf(a.tagName) < 0) if (u.node.isDeletable(a)) be(a).remove(), be(e).replaceWith(be.FE.MARKERS); else if (u.node.isBlock(a) && u.node.isEditable(a)) if (u.node.isList(a)) if (u.node.isEmpty(n, !0)) be(n).remove(), be(a).find("li:first").prepend(be.FE.MARKERS); else {
          ...
          if ((i = u.node.contents(a)).length && "BR" == i[0].tagName && be(i[0]).remove(), "BLOCKQUOTE" != a.tagName && "BLOCKQUOTE" == n.tagName) for (i = u.node.contents(n); i.length && u.node.isBlock(i[i.length - 1]);) n = i[i.length - 1], i = u.node.contents(n); else if ("BLOCKQUOTE" == a.tagName && "BLOCKQUOTE" != n.tagName) for (i = u.node.contents(a); i.length && u.node.isBlock(i[0]);) a = i[0], i = u.node.contents(a);
    ...
    function n(e) {
      ...
      if ("BR" == (n = n.nextSibling).tagName && u.node.isEditable(n)) if (n.nextSibling) {
        if (u.node.isBlock(n.nextSibling) && u.node.isEditable(n.nextSibling)) {
          if (!(be.FE.NO_DELETE_TAGS.indexOf(n.nextSibling.tagName) < 0)) return void be(n).remove();
          n = n.nextSibling, be(n.previousSibling).remove()
        }
      } else if (a(n)) {
        if (s(e)) u.cursorLists._del(e); else u.node.deepestParent(n) && ((!u.node.isEmpty(u.node.blockParent(n)) || (u.node.blockParent(n).nextSibling && be.FE.NO_DELETE_TAGS.indexOf(u.node.blockParent(n).nextSibling.tagName)) < 0) && be(n).remove(), l(e));
        return
      }
      ...
      } else if (be.FE.NO_DELETE_TAGS.indexOf(n.tagName) < 0 && (u.node.isEditable(n) || u.node.isDeletable(n))) if (u.node.isDeletable(n)) be(e).replaceWith(be.FE.MARKERS), be(n).remove(); else if (u.node.isList(n)) e.previousSibling ? (be(n).find("li:first").prepend(e), u.cursorLists._backspace(e)) : (be(n).find("li:first").prepend(be.FE.MARKERS), be(e).remove()); else if ((t = u.node.contents(n)) && "BR" == t[0].tagName && be(t[0]).remove(), t && "BLOCKQUOTE" == n.tagName) {
        var r = t[0];
      ...
      } else be(e).after(be(n).html()).after(be.FE.MARKERS), be(n).remove()
    }
    ...
    function p(e, t, n) {
      ...
      if (i && "BLOCKQUOTE" == i.tagName) return g(e, i) ? (r = u.html.defaultTag(), t ? be(e).replaceWith("<br>" + be.FE.MARKERS) : r ? be(i).after("<" + r + ">" + be.FE.MARKERS + "<br></" + r + ">") : be(i).after(be.FE.MARKERS + "<br>"), be(e).remove()) : m(e, t, n), !1;
      if (null == i) (r = u.html.defaultTag()) && u.node.isElement(e.parentNode) ? be(e).replaceWith("<" + r + ">" + be.FE.MARKERS + "<br></" + r + ">") : !e.previousSibling || be(e.previousSibling).is("br") || e.nextSibling ? be(e).replaceWith("<br>" + be.FE.MARKERS) : be(e).replaceWith("<br>" + be.FE.MARKERS + "<br>"); else {
        var a = e, o = "";
    ...
    function m(e, t, n) {
      ...
      if (null == r) u.html.defaultTag() && e.parentNode === u.el ? be(e).replaceWith("<" + u.html.defaultTag() + ">" + be.FE.MARKERS + "<br></" + u.html.defaultTag() + ">") : (e.nextSibling && !u.node.isBlock(e.nextSibling) || be(e).after("<br>"), be(e).replaceWith("<br>" + be.FE.MARKERS)); else {
        var i = e, a = "";
        "PRE" == r.tagName && (t = !0), u.node.isBlock(r) && !t || (a = "<br>");
        var o = "", s = "";
        do {
          var l = i;
          if (i = i.parentNode, "BLOCKQUOTE" == r.tagName && u.node.isEmpty(l) && !u.node.hasClass(l, "fr-marker") && 0 < be(l).find(e).length && be(l).after(e), "BLOCKQUOTE" != r.tagName || !g(e, i) && !h(e, i)) if (!t || i != r || t && !u.node.isBlock(r)) {
        ...
        if ("BLOCKQUOTE" == r.tagName) if (e.previousSibling && u.node.isBlock(e.previousSibling) && e.nextSibling && "BR" == e.nextSibling.tagName && (be(e.nextSibling).after(e), e.nextSibling && "BR" == e.nextSibling.tagName && be(e.nextSibling).remove()), t) a = o + a + be.FE.MARKERS + s; else {
          var f = u.html.defaultTag();
          a = o + a + (f ? "<" + f + ">" : "") + be.FE.MARKERS + "<br>" + (f ? "</" + f + ">" : "") + s
        } else a = o + a + s + (c ? "" : be.FE.INVISIBLE_SPACE) + be.FE.MARKERS;
        be(e).replaceWith('<span id="fr-break"></span>');
    ...
    return {
      enter: function (t) {
        ...
        0 < be(n).parentsUntil(u.$el, "BLOCKQUOTE").length && (r = !0), be(n).parentsUntil(u.$el, "TD, TH").length && (r = !1), a(n) ? !s(n) || t || r ? p(n, t, r) : u.cursorLists._endEnter(n) : o(n) ? !s(n) || t || r ? function e(t, n, r) {
          ...
          if (a && "TABLE" == a.tagName) return be(a).find("td:first, th:first").prepend(t), e(t, n, r);
          if (a && "BLOCKQUOTE" == a.tagName) if (h(t, a)) {
            if (!n) return (i = u.html.defaultTag()) ? be(a).before("<" + i + ">" + be.FE.MARKERS + "<br></" + i + ">") : be(a).before(be.FE.MARKERS + "<br>"), be(t).remove(), !1
          } else g(t, a) ? p(t, n, !0) : m(t, n, !0);
          if (null == a) (i = u.html.defaultTag()) && u.node.isElement(t.parentNode) ? be(t).replaceWith("<" + i + ">" + be.FE.MARKERS + "<br></" + i + ">") : be(t).replaceWith("<br>" + be.FE.MARKERS); else {
            if (u.node.isBlock(a)) if ("PRE" == a.tagName && (n = !0), n) be(t).remove(), be(a).prepend("<br>" + be.FE.MARKERS); else {
              if (u.node.isEmpty(a, !0)) return p(t, n, r);
              if (u.opts.keepFormatOnDelete) {
                for (var o = t, s = be.FE.INVISIBLE_SPACE; o != a && !u.node.isElement(o);) o = o.parentNode, s = u.node.openTagString(o) + s + u.node.closeTagString(o);
                be(a).before(s)
              } else be(a).before(u.node.openTagString(be(a).clone().removeAttr("id").get(0)) + "<br>" + u.node.closeTagString(a))
            } else be(a).before("<br>");
            be(t).remove()
          }
        ...
        for (var n = t.parentNode; n && !u.node.isElement(n);) {
          if ("false" === n.getAttribute("contenteditable")) return be(t).replaceWith(be.FE.MARKERS), u.selection.restore(), !1;
        ...
        return a(t) ? e = c(t) : o(t) ? s(t) && h(t, be(t).parents("li:first").get(0)) ? u.cursorLists._backspace(t) : function (e) {
          for (var t = 0 < be(e).parentsUntil(u.$el, "BLOCKQUOTE").length, n = u.node.deepestParent(e, [], !t), r = n; n && !n.previousSibling && "BLOCKQUOTE" != n.tagName && n.parentElement != u.el && !u.node.hasClass(n.parentElement, "fr-inner") && be.FE.SIMPLE_ENTER_TAGS.indexOf(n.parentElement.tagName) < 0;) n = n.parentElement;
          if (n && "BLOCKQUOTE" == n.tagName) {
          ...
          if (null !== n) {
            ...
            if (u.node.isBlock(n) && u.node.isEditable(n) && o && be.FE.NO_DELETE_TAGS.indexOf(o.tagName) < 0) if (u.node.isDeletable(o)) be(o).remove(), be(e).replaceWith(be.FE.MARKERS); else if (u.node.isEditable(o)) if (u.node.isBlock(o)) if (u.node.isEmpty(o) && !u.node.isList(o)) be(o).remove(), be(e).after(u.opts.keepFormatOnDelete ? be.FE.INVISIBLE_SPACE : ""); else {
              if (u.node.isList(o) && (o = be(o).find("li:last").get(0)), (a = u.node.contents(o)).length && "BR" == a[a.length - 1].tagName && be(a[a.length - 1]).remove(), "BLOCKQUOTE" == o.tagName && "BLOCKQUOTE" != n.tagName) for (a = u.node.contents(o); a.length && u.node.isBlock(a[a.length - 1]);) o = a[a.length - 1], a = u.node.contents(o); else if ("BLOCKQUOTE" != o.tagName && "BLOCKQUOTE" == r.tagName) for (a = u.node.contents(r); a.length && u.node.isBlock(a[0]);) r = a[0], a = u.node.contents(r);
              if (u.node.isEmpty(n)) be(e).remove(), u.selection.setAtEnd(o, !0); else {
            ...
            } else be(e).replaceWith(be.FE.MARKERS), "BLOCKQUOTE" == n.tagName && o.nodeType == Node.ELEMENT_NODE ? be(o).remove() : (be(o).after(u.node.isEmpty(n) ? "" : be(n).html()), be(n).remove(), "BR" == o.tagName && be(o).remove())
          }
        ...
        if (!e) return !1;
        if (u.el.normalize(), a(e)) if (s(e)) if (0 === be(e).parents("li:first").find("ul, ol").length) u.cursorLists._del(e); else {
    ...
    IME: 229
  }, be.extend(be.FE.DEFAULTS, {enter: be.FE.ENTER_P, multiLine: !0, tabSpaces: 0}), be.FE.MODULES.keys = function (l) {
    var d, n, r, c = !1;
    ...
    function o(e) {
      ...
      var n = e.which;
      if (16 === n) return !0;
      if ((d = n) === be.FE.KEYCODE.IME) return c = !0;
      c = !1;
      var r, i, a, o = m(n) && !h(e) && !e.altKey, s = n == be.FE.KEYCODE.BACKSPACE || n == be.FE.KEYCODE.DELETE;
    ...
    function u(e) {
      ...
      if (c) return !1;
      if (e && l.helpers.isIOS() && e.which == be.FE.KEYCODE.ENTER && l.doc.execCommand("undo"), !l.selection.isCollapsed()) return !0;
      if (e && (e.which === be.FE.KEYCODE.META || e.which == be.FE.KEYCODE.CTRL)) return !0;
      if (e && g(e.which)) return !0;
      if (e && !l.helpers.isIOS() && (e.which == be.FE.KEYCODE.ENTER || e.which == be.FE.KEYCODE.BACKSPACE || 37 <= e.which && e.which <= 40 && !l.browser.msie)) try {
        s()
      } catch (n) {
      }
      p()
    ...
    function g(e) {
      if (e >= be.FE.KEYCODE.ARROW_LEFT && e <= be.FE.KEYCODE.ARROW_DOWN) return !0
    }

    function m(e) {
      if (e >= be.FE.KEYCODE.ZERO && e <= be.FE.KEYCODE.NINE) return !0;
      if (e >= be.FE.KEYCODE.NUM_ZERO && e <= be.FE.KEYCODE.NUM_MULTIPLY) return !0;
    ...
    function v(e) {
      var t = e.which;
      if (h(e) || 37 <= t && t <= 40 || !m(t) && t != be.FE.KEYCODE.DELETE && t != be.FE.KEYCODE.BACKSPACE && t != be.FE.KEYCODE.ENTER && t != be.FE.KEYCODE.IME) return !0;
    ...
    function r(r) {
      r && r.length && (f.events.$on(r, "keydown", function (e) {
        if (!be(e.target).is("a.fr-command, button.fr-command, .fr-group span.fr-command")) return !0;
        ...
        var d, c, t = f.popups.get(e), n = (d = e, c = f.popups.get(d), {
          _tiKeydown: function (e) {
            ...
            if (be.FE.KEYCODE.TAB == n) {
              ...
              if (0 <= o && o < a.length) return t.events.disableBlur(), be(a[o]).focus(), e.stopPropagation(), !1;
              var s = c.find(".fr-buttons");
              if (s.length && p(s, !!e.shiftKey)) return e.stopPropagation(), !1;
              if (u(i)) return e.stopPropagation(), !1
            } else {
              if (be.FE.KEYCODE.ENTER != n || !e.target || "TEXTAREA" === e.target.tagName) return be.FE.KEYCODE.ESC == n ? (e.preventDefault(), e.stopPropagation(), t.accessibility.restoreSelection(), t.popups.isVisible(d) && c.find(".fr-back:visible").length ? (t.opts.toolbarInline && (t.events.disableBlur(), t.events.focus()), t.button.exec(c.find(".fr-back:visible:first")), E(c)) : t.popups.isVisible(d) && c.find(".fr-dismiss:visible").length ? t.button.exec(c.find(".fr-dismiss:visible:first")) : (t.popups.hide(d), t.opts.toolbarInline && t.toolbar.showInline(null, !0), E(c)), !1) : be.FE.KEYCODE.SPACE == n && (r.is(".fr-submit") || r.is(".fr-dismiss")) ? (e.preventDefault(), e.stopPropagation(), t.events.disableBlur(), t.button.exec(r), !0) : t.keys.isBrowserAction(e) ? void e.stopPropagation() : r.is("input[type=text], textarea") ? void e.stopPropagation() : be.FE.KEYCODE.SPACE == n && (r.is(".fr-link-attr") || r.is("input[type=file]")) ? void e.stopPropagation() : (e.stopPropagation(), e.preventDefault(), !1);
              var l = null;
    ...
    function m(e, t, n) {
      if (e) {
        ...
        if (e) {
          ...
          if (i) (be(i).find(".fr-marker").length || "UL" == i.tagName || "OL" == i.tagName) && m(i.firstChild, t, n); else {
    ...
    function r(t, n) {
      ...
      !function e(t, n, r, i) {
        for (var a = g.node.contents(t.get(0)), o = 0; o < a.length; o++) {
          var s = a[o];
          if (g.node.hasClass(s, "fr-marker")) n = (n + 1) % 2; else if (n) if (0 < be(s).find(".fr-marker").length) n = e(be(s), n, r, i); else {
          ...
          } else 0 < be(s).find(".fr-marker").length && (n = e(be(s), n, r, i))
        }
        return n
    ...
    function t(e, t) {
      ...
      if (g.selection.isCollapsed()) {
        ...
        if (g.node.openTagString(l.get(0)) == '<span style="' + e + ": " + l.css(e) + ';">') {
          if (g.node.isEmpty(l.get(0))) s = be('<span style="' + e + ": " + t + ';">' + be.FE.INVISIBLE_SPACE + be.FE.MARKERS + "</span>"), l.replaceWith(s); else {
            var d = {};
        ...
        for (t && (p.style = e + ": " + t + ";"), m(f, "span", p), g.$el.find(".fr-marker + .fr-unprocessed").each(function () {
          ...
          var h = s.find("span");
          for (n = h.length - 1; 0 <= n; n--) i = h[n], a = e, o = void 0, (o = be(i)).css(a, ""), "" === o.attr("style") && o.replaceWith(o.html());
          E(s, e, t)
        }
      }
      !function () {
    ...
    function E(e, t, n) {
      ...
      for (r = o.length - 1; 0 <= r; r--) i = o[r], a = t, 0 === be(i).attr("style").indexOf(a + ":") || 0 <= be(i).attr("style").indexOf(";" + a + ":") || 0 <= be(i).attr("style").indexOf("; " + a + ":") || s.push(o[r]);
      if ((o = o.not(s)).length) {
  ...
  }, be.extend(be.FE.DEFAULTS, {indentMargin: 20}), be.FE.COMMANDS = {
    bold: {
      title: "Bold",
      toggle: !0,
      refresh: function (e) {
    ...
    function t(e, t) {
      if (!1 !== o.events.trigger("commands.before", be.merge([e], t || []))) {
        var n = be.FE.COMMANDS[e] && be.FE.COMMANDS[e].callback || a[e], r = !0, i = !1;
    ...
    function n(e) {
      ...
      for (var t = o.selection.blocks(), n = 0; n < t.length; n++) if ("LI" != t[n].tagName && "LI" != t[n].parentNode.tagName) {
        var r = be(t[n]), i = "rtl" == o.opts.direction || "rtl" == r.css("direction") ? "margin-right" : "margin-left",
    ...
    return be.extend(s, {
      exec: t, _init: function () {
        o.events.on("keydown", function (e) {
          ...
          var t = o.selection.element();
          if (t && "HR" == t.tagName) if (e.which == be.FE.KEYCODE.ARROW_LEFT || e.which == be.FE.KEYCODE.ARROW_UP) {
            if (t.previousSibling) return o.node.isBlock(t.previousSibling) ? o.selection.setAtEnd(t.previousSibling) : be(t).before(be.FE.MARKERS), o.selection.restore(), !1
          } else if ((e.which == be.FE.KEYCODE.ARROW_RIGHT || e.which == be.FE.KEYCODE.ARROW_DOWN) && t.nextSibling) return o.node.isBlock(t.nextSibling) ? o.selection.setAtStart(t.nextSibling) : be(t).after(be.FE.MARKERS), o.selection.restore(), !1
    ...
    return {
      _init: function () {
        ...
        for (var n, r, i, a = !(p.ul = !0), o = 0, s = 0; s < e.length; s++) {
          var l = (r = e[s], 3 === (i = (E(r) || "").split("|")).length ? i : [null, null, E(r) || ""]), d = l[2];
    ...
    function d(e, t, n) {
      ...
      if ("string" == typeof c && (e = c), "" !== e) {
        ...
        if (b.opts.enter == be.FE.ENTER_BR) for (r = (i = f.querySelectorAll("p, div")).length - 1; 0 <= r; r--) 0 === (a = i[r]).attributes.length && (a.outerHTML = a.innerHTML + (a.nextSibling && !b.node.isEmpty(a) ? "<br>" : "")); else if (b.opts.enter == be.FE.ENTER_DIV) for (r = (i = f.getElementsByTagName("p")).length - 1; 0 <= r; r--) 0 === (a = i[r]).attributes.length && (a.outerHTML = "<div>" + a.innerHTML + "</div>"); else b.opts.enter == be.FE.ENTER_P && 1 == f.childNodes.length && "P" == f.childNodes[0].tagName && 0 === f.childNodes[0].attributes.length && (f.childNodes[0].outerHTML = f.childNodes[0].innerHTML);
    ...
    function e(e) {
      ...
      if ("keyup" == e.type && l && t != be.FE.KEYCODE.META) return l = !1;
      "keydown" == e.type && (l = !1);
      ...
      if (n && be.FE.SHORTCUTS_MAP[r]) {
        ...
        if (i && 0 <= s.opts.shortcutsEnabled.indexOf(i)) {
          var a, o = be.FE.SHORTCUTS_MAP[r].val;
          ...
          if (i && (s.commands[i] || be.FE.COMMANDS[i] && be.FE.COMMANDS[i].callback)) return e.preventDefault(), e.stopPropagation(), "keydown" == e.type && ((s.commands[i] || be.FE.COMMANDS[i].callback)(), l = !0), !1
        }
      }
    }
    ...
    return {
      _init: function () {
        ...
        if (!r) for (var t in r = {}, be.FE.SHORTCUTS_MAP) be.FE.SHORTCUTS_MAP.hasOwnProperty(t) && 0 <= s.opts.shortcutsEnabled.indexOf(be.FE.SHORTCUTS_MAP[t].cmd) && (r[be.FE.SHORTCUTS_MAP[t].cmd + "." + (be.FE.SHORTCUTS_MAP[t].val || "")] = {
    ...
    be.FE.ICONS[e] = t
  }, be.extend(be.FE.DEFAULTS, {iconsTemplate: "font_awesome"}), be.FE.MODULES.icon = function (i) {
    return {
      create: function (n) {
        var e = null, r = be.FE.ICONS[n];
        if (void 0 !== r) {
        ...
        var t = be.FE.ICONS[e], n = i.opts.iconsTemplate;
        return void 0 !== t ? n = t.template || be.FE.ICON_DEFAULT_TEMPLATE || i.opts.iconsTemplate : n
      }
    }
  }, be.extend(be.FE.DEFAULTS, {tooltips: !0}), be.FE.MODULES.tooltip = function (i) {
    function r() {
    ...
    function t(e) {
      ...
      if (0 !== e.parents(".fr-popup").length || e.data("popup") || t.popups.hideAll(), t.popups.areVisible() && !t.popups.areVisible(t)) {
        for (var n = 0; n < be.FE.INSTANCES.length; n++) be.FE.INSTANCES[n] != t && be.FE.INSTANCES[n].popups && be.FE.INSTANCES[n].popups.areVisible() && be.FE.INSTANCES[n].$el.find(".fr-marker").remove();
        t.popups.hideAll()
      }
    ...
    function h(e, t, n) {
      if (t = be.extend(!0, {}, t), u.helpers.isMobile() && !1 === t.showOnMobile) return "";
    ...
    return {
      _init: function () {
        ...
        var n = t.get(0).ownerDocument, r = "defaultView" in n ? n.defaultView : n.parentWindow, i = function (e) {
    ...
    return {
      _init: function () {
        ...
        if (d[e]) {
          var t = d[e], n = t.$modal, r = t.$body, i = be(l.o_win).height(), a = n.find(".fr-modal-wrapper"),
  ...
  }, be.FE.POPUP_TEMPLATES = {"text.edit": "[_EDIT_]"}, be.FE.RegisterTemplate = function (e, t) {
    ...
    function v(r) {
      ...
      return {
        _windowResize: function () {
          ...
          var t = i.data("instance") || c, n = be(e.currentTarget);
          ...
          if (n && !be(n).is(r) && 0 === be(n).parents(r).length) return e.stopPropagation(), !1;
    ...
    function n(e) {
      var n = be(e), t = n.is(".fr-sticky-on"), r = n.data("sticky-top"), i = n.data("sticky-scheduled");
      if (void 0 === r) {
        n.data("sticky-top", 0);
      ...
      } else clearTimeout(be(e).css("sticky-timeout")), n.css("top", "0"), n.css("position", ""), n.width(""), n.data("sticky-top", 0), n.removeClass("fr-sticky-on"), v.$box.removeClass("fr-sticky-box")
    }

    function t(e) {
      if (e.offsetWidth) {
        var t, n, r = be(e), i = r.outerHeight(), a = r.data("sticky-position"),
          o = be("body" == v.opts.scrollableContainer ? v.o_win : v.opts.scrollableContainer).outerHeight(), s = 0,
          l = 0;
          ...
          if (v._stickyElements = [], v.helpers.isIOS()) {
            ...
            t(), v.events.$on(be(v.o_win), "scroll", function () {
              if (v.core.hasFocus()) for (var e = 0; e < v._stickyElements.length; e++) {
                var t = be(v._stickyElements[e]), n = t.parent(), r = v.helpers.scrollTop();
                t.outerHeight() < r - n.offset().top && (t.addClass("fr-opacity-0"), t.data("sticky-top", -1), t.data("sticky-scheduled", -1))
              }
            }, !0)
          } else "body" !== v.opts.scrollableContainer && v.events.$on(be(v.opts.scrollableContainer), "scroll", e, !0), v.events.$on(be(v.o_win), "scroll", e, !0), v.events.$on(be(v.o_win), "resize", e, !0), v.events.on("initialized", e), v.events.on("focus", e), v.events.$on(be(v.o_win), "resize", "textarea", e, !0);
    ...
    return {
      undo: function (e) {
        ...
        for (var t = i.selection.blocks(), n = 0; n < t.length; n++) {
          ...
          if (0 < i.helpers.getPX(be(t[n]).css(r))) return a(e, !1), !0
        }
        a(e, !0)
      }, indent: function (e) {
        if (i.node.hasClass(e.get(0), "fr-no-refresh")) return !1;
  ...
  }, be.extend(be.FE.DEFAULTS, {editInPopup: !1}), be.FE.MODULES.textEdit = function (n) {
    function t() {
    ...
    function d() {
      i.events.on("window.mousedown", n), i.events.on("keydown", n), i.events.on("blur", n), i.helpers.isMobile() || i.events.on("window.mouseup", t), i.helpers.isMobile() ? i.helpers.isIOS() || (i.events.on("window.touchend", t), i.browser.mozilla && setInterval(t, 200)) : i.events.on("window.keyup", l), i.events.on("keydown", function (e) {
        ...
        if (e.which == be.FE.KEYCODE.ALT) return e.stopPropagation(), !1
    ...
    return {
      _init: function () {
        if (i.$sc = be(i.opts.scrollableContainer).first(), !i.$wp) return !1;
    ...
    return {
      apply: function (e) {
        ...
        if (be(t).parents(".fr-img-caption").length) be(t).css("text-align", e); else {
          i.selection.save(), i.html.wrap(!0, !0, !0, !0), i.selection.restore();
          for (var n = i.selection.blocks(), r = 0; r < n.length; r++) i.helpers.getAlignment(be(n[r].parentNode)) == e ? be(n[r]).css("text-align", "").removeClass("fr-temp-div") : be(n[r]).css("text-align", e).removeClass("fr-temp-div"), "" === be(n[r]).attr("class") && be(n[r]).removeAttr("class"), "" === be(n[r]).attr("style") && be(n[r]).removeAttr("style");
  ...
  }, be.FE.DefineIcon("align", {NAME: "align-left"}), be.FE.DefineIcon("align-left", {NAME: "align-left"}), be.FE.DefineIcon("align-right", {NAME: "align-right"}), be.FE.DefineIcon("align-center", {NAME: "align-center"}),be.FE.DefineIcon("align-justify", {NAME: "align-justify"}),be.FE.RegisterCommand("align", {
    type: "dropdown",
    title: "Align",
    options: {left: "Align Left", center: "Align Center", right: "Align Right", justify: "Align Justify"},
    html: function () {
      var e = '<ul class="fr-dropdown-list" role="presentation">', t = be.FE.COMMANDS.align.options;
  ...
  }),be.extend(be.FE.DEFAULTS, {charCounterMax: -1, charCounterCount: !0}),be.FE.PLUGINS.charCounter = function (n) {
    var r;
    ...
    plugin: "codeView"
  }),be.FE.DefineIcon("html", {NAME: "code"}),be.extend(be.FE.POPUP_TEMPLATES, {"colors.picker": "[_BUTTONS_][_TEXT_COLORS_][_BACKGROUND_COLORS_][_CUSTOM_COLOR_]"}),be.extend(be.FE.DEFAULTS, {
    ...
    function i(e) {
      var t, n = g.popups.get("colors.picker"), r = be(g.selection.element());
      ...
      showColorsPopup: function () {
        ...
        if (t || (t = function () {
          ...
          return h = i, g.events.on("popup.tab", function (e) {
            ...
            if (be.FE.KEYCODE.TAB == n) {
              ...
              if (t.is("span.fr-select-color")) {
                var a = t.parent().find("span.fr-select-color"), o = a.index(t), s = g.opts.colorsStep,
                  l = Math.floor(a.length / s), d = o % s, c = Math.floor(o / s), f = c * s + d, p = l * s;
            ...
            } else be.FE.KEYCODE.ENTER == n && (g.button.exec(t), r = !1);
  ...
  },be.FE.DefineIcon("colors", {NAME: "tint"}),be.FE.RegisterCommand("color", {
    title: "Colors",
    undo: !1,
    focus: !0,
    refreshOnCallback: !1,
  ...
  }),be.FE.DefineIcon("colorsBack", {NAME: "arrow-left"}),be.FE.RegisterCommand("colorsBack", {
    title: "Back",
    undo: !1,
    focus: !1,
    back: !0,
  ...
  }),be.FE.DefineIcon("remove", {NAME: "eraser"}),be.extend(be.FE.DEFAULTS, {dragInline: !0}),be.FE.PLUGINS.draggable = function (d) {
    function e(e) {
    ...
    function t(e) {
      e.originalEvent.dataTransfer.dropEffect = "move", d.opts.dragInline ? function () {
        for (var e = null, t = 0; t < be.FE.INSTANCES.length; t++) if ((e = be.FE.INSTANCES[t].$el.find(".fr-dragging")).length) return e.get(0)
        ...
        if (!c(t)) {
          ...
          for (var i = 0, a = t; !c(a) && a == t && e.originalEvent.pageY - d.win.pageYOffset + i < be(d.doc).height();) i++, a = d.doc.elementFromPoint(e.originalEvent.pageX - d.win.pageXOffset, e.originalEvent.pageY - d.win.pageYOffset + i);
          (!c(a) || p && 0 === d.$el.find(a).length && a != p.get(0)) && (a = null), t = null == a && r ? r : a && null == r ? a : a && r ? n < i ? r : a : null
        }
        if (be(t).hasClass("fr-drag-helper")) return;
    ...
    function i(e) {
      var t, n;
      d.$el.attr("contenteditable", !0);
      for (var r = 0; r < be.FE.INSTANCES.length; r++) if ((t = be.FE.INSTANCES[r].$el.find(".fr-dragging")).length) {
        n = be.FE.INSTANCES[r];
        break
      }
      if (t.length) {
        ...
        var i = t;
        if (t.parent().is("A") && 1 == t.parent().get(0).childNodes.length && (i = t.parent()), d.core.isEmpty()) d.events.focus(); else d.$el.find(".fr-marker").replaceWith(be.FE.MARKERS), d.selection.restore();
  ...
  },be.extend(be.FE.POPUP_TEMPLATES, {emoticons: "[_BUTTONS_][_EMOTICONS_]"}),be.extend(be.FE.DEFAULTS, {
    emoticonsStep: 8,
    ...
    }, {code: "1f60b", desc: "Face savoring delicious food"}, {code: "1f60c", desc: "Relieved face"}, {
      code: "1f60d",
      desc: "Smiling face with heart-shaped eyes"
    }, {code: "1f60e", desc: "Smiling face with sunglasses"}, {code: "1f60f", desc: "Smirking face"}, {
      code: "1f610",
      desc: "Neutral face"
    }, {code: "1f611", desc: "Expressionless face"}, {code: "1f612", desc: "Unamused face"}, {
      code: "1f613",
      desc: "Face with cold sweat"
    }, {code: "1f614", desc: "Pensive face"}, {code: "1f615", desc: "Confused face"}, {
      code: "1f616",
      desc: "Confounded face"
    }, {code: "1f617", desc: "Kissing face"}, {code: "1f618", desc: "Face throwing a kiss"}, {
      code: "1f619",
    ...
    }, {code: "1f626", desc: "Frowning face with open mouth"}, {code: "1f627", desc: "Anguished face"}, {
      code: "1f628",
      desc: "Fearful face"
    }, {code: "1f629", desc: "Weary face"}, {code: "1f62a", desc: "Sleepy face"}, {
      code: "1f62b",
      desc: "Tired face"
    }, {code: "1f62c", desc: "Grimacing face"}, {code: "1f62d", desc: "Loudly crying face"}, {
      code: "1f62e",
    ...
    return {
      _init: function () {
        ...
        e(), m.events.on("html.set", e), m.events.on("keydown", function (e) {
          ...
          for (var t = m.el.querySelectorAll(".fr-emoticon"), n = 0; n < t.length; n++) "undefined" != typeof t[n].textContent && 0 === t[n].textContent.replace(/\u200B/gi, "").length && be(t[n]).remove();
          ...
          return m.tooltip.bind(n, ".fr-emoticon"), g = n, m.events.on("popup.tab", function (e) {
            ...
            if (be.FE.KEYCODE.TAB == a) {
              ...
              if (t.is("span.fr-emoticon")) {
                ...
                r = l.index(t);
                var d = m.opts.emoticonsStep, c = Math.floor(l.length / d), f = r % d, p = Math.floor(r / d),
                  u = p * d + f, h = c * d;
            ...
            } else be.FE.KEYCODE.ENTER == a && (t.is("a") ? t[0].click() : m.button.exec(t), n = !1);
  ...
  }),be.FE.DefineIcon("emoticonsBack", {NAME: "arrow-left"}),be.FE.RegisterCommand("emoticonsBack", {
    title: "Back",
    undo: !1,
    focus: !1,
    back: !0,
    ...
    return {
      _init: function () {
        ...
        var e = be("<div>").html(i.opts.entities).text(), t = i.opts.entities.split(";");
        o = {}, a = "";
        for (var n = 0; n < e.length; n++) {
          var r = e.charAt(n);
  ...
  },be.extend(be.FE.POPUP_TEMPLATES, {"file.insert": "[_BUTTONS_][_UPLOAD_LAYER_][_PROGRESS_BAR_]"}),be.extend(be.FE.DEFAULTS, {
    fileUpload: !0,
    fileUploadURL: null,
    ...
    function v(e) {
      ...
      try {
        if (d.opts.fileUploadToS3) if (201 == t) {
          var a = function (e) {
            try {
              var t = be(e).find("Location").text(), n = be(e).find("Key").text();
    ...
    plugin: "file"
  }),be.FE.DefineIcon("fileBack", {NAME: "arrow-left"}),be.FE.RegisterCommand("fileBack", {
    title: "Back",
    undo: !1,
    focus: !1,
    back: !0,
    ...
    function s() {
      var e = a(be(i.selection.element()).css("font-family")), t = [];
  ...
  }),be.FE.DefineIcon("fontFamily", {NAME: "font"}),be.extend(be.FE.DEFAULTS, {
  ...
  }),be.FE.DefineIcon("fontSize", {NAME: "text-height"}),be.extend(be.FE.POPUP_TEMPLATES, {
    ...
    return {
      _init: function () {
        ...
        var e = a.popups.get("forms.update"), t = s();
        if (t) {
          var n = be(t), r = e.find('input[type="text"][name="text"]').val() || "";
        ...
        var e = s();
        if (e) {
          var t = be(e), n = a.popups.get("forms.update");
  ...
  }),be.FE.DefineIcon("inputStyle", {NAME: "magic"}),be.FE.RegisterCommand("inputStyle", {
    title: "Style",
    type: "dropdown",
    html: function () {
  ...
  }),be.FE.DefineIcon("inputEdit", {NAME: "edit"}),be.FE.RegisterCommand("inputEdit", {
    title: "Edit Button",
    undo: !1,
    refreshAfterCallback: !1,
    callback: function () {
  ...
  }),be.FE.DefineIcon("inputBack", {NAME: "arrow-left"}),be.FE.RegisterCommand("inputBack", {
    title: "Back",
    undo: !1,
    focus: !1,
    back: !0,
    ...
    plugin: "fullscreen"
  }),be.FE.DefineIcon("fullscreen", {NAME: "expand"}),be.FE.DefineIcon("fullscreenCompress", {NAME: "compress"}),be.extend(be.FE.DEFAULTS, {
    helpSets: [{
      title: "Inline Editor",
      ...
      title: "Quote",
      commands: [{val: "OSkey'", desc: "Increase quote level"}, {val: "OSkeyShift+'", desc: "Decrease quote level"}]
    }, {
      title: "Image / Video",
  ...
  },be.FroalaEditor.DefineIcon("help", {NAME: "question"}),be.FE.RegisterShortcut(be.FE.KEYCODE.SLASH, "help", null, "/"),be.FE.RegisterCommand("help", {
    title: "Help",
    icon: "help",
    undo: !1,
    focus: !1,
    ...
    var f, l, d, p, s, n, u = "https://i.froala.com/upload", t = !1, r = 1, h = 2, g = 3, m = 4, v = 5, E = 6, b = 8,
      i = {};
    ...
    function C(e) {
      ...
      for (t = 0; t < n.length; t++) if (r.push(n[t].getAttribute("src")), be(n[t]).toggleClass("fr-draggable", c.opts.imageMove), "" === n[t].getAttribute("class") && n[t].removeAttribute("class"), "" === n[t].getAttribute("style") && n[t].removeAttribute("style"), n[t].parentNode && n[t].parentNode.parentNode && c.node.hasClass(n[t].parentNode.parentNode, "fr-img-caption")) {
      ...
      if (s) for (t = 0; t < s.length; t++) r.indexOf(s[t].getAttribute("src")) < 0 && c.events.trigger("image.removed", [be(s[t])]);
      if (s && e) {
        var o = [];
        for (t = 0; t < s.length; t++) o.push(s[t].getAttribute("src"));
        for (t = 0; t < n.length; t++) o.indexOf(n[t].getAttribute("src")) < 0 && c.events.trigger("image.loaded", [be(n[t])])
      }
      s = n
    }
    ...
    function _(e) {
      ...
      if (d && f) {
        ...
        } else i + r >= c.opts.imageMinWidth && (R(i + r), t = Ee() ? c.helpers.getPX(f.parents(".fr-img-caption").css("width")) : c.helpers.getPX(f.css("width"))), t !== i + r && R(t), ((f.attr("style") || "").match(/(^height:)|(; *height:)/) || f.attr("height")) && (f.css("height", d.data("start-height") * f.width() / d.data("start-width")), f.removeAttr("height"));
    ...
    function F(o, e, s, l, d) {
      ...
      t.onload = function () {
        ...
        } else e = P(o, s, k), C(!1), c.undo.saveStep(), c.events.disableBlur(), c.$el.blur(), c.events.trigger("image.inserted", [e, d])
      }, t.onerror = function () {
        x(r)
    ...
    function M(e) {
      ...
      try {
        if (c.opts.imageUploadToS3) if (201 == t) {
          ...
          a && F(a, !1, [], e, n || r)
        } else x(m, n || r, e); else if (200 <= t && t < 300) {
          var o = function (e) {
            try {
    ...
    function K(e, t) {
      if (void 0 !== e && 0 < e.length) {
        ...
        if (r.name || (r.name = (new Date).getTime() + "." + (r.type || "image/jpeg").replace(/image\//g, "")), r.size > c.opts.imageMaxSize) return x(v), !1;
        if (c.opts.imageAllowedTypes.indexOf(r.type.replace(/image\//g, "")) < 0) return x(E), !1;
    ...
    function z(e) {
      if (e) return c.popups.onRefresh("image.insert", T), c.popups.onHide("image.insert", A), !0;
      var t, n = "";
      ...
      var r = c.opts.imageInsertButtons.indexOf("imageUpload"), i = c.opts.imageInsertButtons.indexOf("imageByURL"),
        a = "";
    ...
    function V(e) {
      if (e) return c.popups.onRefresh("image.alt", Y), !0;
      var t = {
    ...
    function j(e) {
      if (e) return c.popups.onRefresh("image.size", X), !0;
      var t = {
    ...
    function J(e) {
      var t = e.which;
      if (f && (t == be.FE.KEYCODE.BACKSPACE || t == be.FE.KEYCODE.DELETE)) return e.preventDefault(), e.stopPropagation(), Z(), !1;
    ...
    function ee(e) {
      ...
      } else if (e && e.nodeType == Node.ELEMENT_NODE) for (var r = e.querySelectorAll("img.fr-uploading, img.fr-error, img.fr-draggable"), i = 0; i < r.length; i++) ee(r[i])
    }
    ...
    function te(e) {
      ...
      for (var t = atob(be(e).attr("src").split(",")[1]), n = [], r = 0; r < t.length; r++) n.push(t.charCodeAt(r));
      K([new Blob([new Uint8Array(n)], {type: be(e).attr("src").split(",")[0].replace(/data\:/g, "").replace(/;base64/g, "")})], f)
    }
    ...
    function ne() {
      c.opts.imagePaste ? c.$el.find("img[data-fr-image-pasted]").each(function (e, n) {
        ...
        if (0 === n.src.indexOf("data:")) te(n); else if (0 === n.src.indexOf("blob:") || 0 === n.src.indexOf("http") && c.opts.imageUploadRemoteUrls && c.opts.imageCORSProxy) {
          var r = new Image;
        ...
        } else 0 !== n.src.indexOf("http") || 0 === n.src.indexOf("https://mail.google.com/mail") ? (c.selection.save(), be(n).remove(), c.selection.restore()) : be(n).removeAttr("data-fr-image-pasted")
    ...
    function ie(e) {
      if (e && e.clipboardData && e.clipboardData.items) {
        ...
        if (t) return r = t, (i = new FileReader).onload = re, i.readAsDataURL(r), !1
      }
      var r, i
    }
    ...
    function oe(e) {
      ...
      for (var t = 0; t < be.FE.INSTANCES.length; t++) be.FE.INSTANCES[t] != c && be.FE.INSTANCES[t].events.trigger("image.hideResizer");
    ...
    return {
      _init: function () {
        ...
        c.events.$on(c.$el, c._mousedown, "IMG" == c.el.tagName ? null : 'img:not([contenteditable="false"])', function (e) {
          ...
          if (f && e.which == be.FE.KEYCODE.ENTER) return !1
          ...
          var t = e.which;
          if (f && t == be.FE.KEYCODE.BACKSPACE) return e.preventDefault(), !1
          ...
          for (var e = 0; e < r.length; e++) {
            var t = r[e].style.width || be(r[e]).width(), n = r[e].style.height || be(r[e]).height();
          ...
          if ("IMG" == e.get(0).tagName) return Z(e), !1
        })
      },
      showInsertPopup: function () {
        var e = c.$tb.find('.fr-command[data-cmd="insertImage"]'), t = c.popups.get("image.insert");
        if (t || (t = z()), O(), !t.hasClass("fr-active")) if (c.popups.refresh("image.insert"), c.popups.setContainer("image.insert", c.$tb), e.is(":visible")) {
          var n = e.offset().left + e.outerWidth() / 2,
      ...
      insertByURL: function () {
        ...
        if (0 < e.val().length) {
          ...
          if (c.opts.imageUploadRemoteUrls && c.opts.imageCORSProxy && c.opts.imageUpload) {
            var n = new XMLHttpRequest;
            n.onload = function () {
              200 == this.status ? K([new Blob([this.response], {type: this.response.type || "image/png"})], f) : x(r)
            }, n.onerror = function () {
              F(t, !0, [], f)
      ...
      toggleCaption: function () {
        ...
        if (f && !Ee()) {
          ...
          var t = e.width();
          e.wrap("<div " + (c.browser.mozilla ? "" : 'contenteditable="false"') + 'class="fr-img-caption ' + f.attr("class") + '" draggable="false"></div>'), e.wrap('<span class="fr-img-wrap"></span>'), e.after('<span style="float: left" class="fr-inner"' + (c.browser.mozilla ? "" : ' contenteditable="true"') + ">" + be.FE.START_MARKER + e[0].dataset.description + be.FE.END_MARKER + "</span>", '<span style="float: right" class="fr-inner"' + (c.browser.mozilla ? "" : ' contenteditable="true"') + ">" + be.FE.START_MARKER + e[0].dataset.credit + be.FE.END_MARKER + "</span><p> </p>"), f.removeAttr("class").removeAttr("style").removeAttr("width"), f.parents(".fr-img-caption").css("width", t + "px"), se(!0), c.selection.restore()
        } else e = ve(), f.insertAfter(e), f.attr("class", e.attr("class").replace("fr-img-caption", "")).attr("style", e.attr("style")), e.remove(), D(f)
      },
      hasCaption: Ee,
      exitEdit: se,
      edit: D
    ...
    refreshOnShow: function (e, t) {
      ...
      n && t.find(".fr-command").each(function () {
        var e = be(this).data("param1"), t = n.hasClass(e);
    ...
    imageManagerLoadURL: "https://km-project.herokuapp.com/api/admin/images/",
    imageManagerLoadMethod: "get",
    imageManagerLoadParams: {},
    imageManagerPreloader: null,
    imageManagerDeleteURL: "https://km-project.herokuapp.com/api/admin/images/",
    ...
    var l, d, r, i, a, c, o, f, p, u, h, g = "image_manager", e = 10, m = 11, v = 12, E = 13, b = 14, T = 15, A = 21,
      C = 22, n = {};
    ...
    function O(e) {
      var t = be(e.currentTarget).siblings("img"), n = l.data("instance") || s, r = l.data("current-image");
      if (s.modals.hide(g), n.image.showProgressBar(), r) r.data("fr-old-src", r.attr("src")), r.trigger("click"); else {
        ...
        var i = n.position.getBoundingRect(), a = i.left + i.width / 2 + be(s.doc).scrollLeft(),
    ...
    function I(e) {
      var n = be(e.currentTarget).siblings("img"), t = s.language.translate("Are you sure? Image will be deleted.");
      confirm(t) && (s.opts.imageManagerDeleteURL ? !1 !== s.events.trigger("imageManager.beforeDeleteImage", [n]) && (n.parent().addClass("fr-image-deleting"), be.ajax({
        ...
        data: be.extend(be.extend({src: n.attr("src")}, N(n)), s.opts.imageManagerDeleteParams),
  ...
  },!be.FE.PLUGINS.image) throw new Error("Image manager plugin requires image plugin.");
  be.FE.DEFAULTS.imageInsertButtons.push("imageManager"), be.FE.RegisterCommand("imageManager", {
    ...
    plugin: "imageManager"
  }), be.FE.DefineIcon("imageManager", {NAME: "folder"}), be.FE.DefineIcon("imageManagerInsert", {NAME: "plus"}), be.FE.DefineIcon("imageManagerDelete", {NAME: "trash"}), be.extend(be.FE.DEFAULTS, {
    inlineClasses: {
      "fr-class-code": "Code",
    ...
    return {
      apply: function (e) {
        ...
        t.find(".fr-command").each(function () {
          var e = be(this).data("param1"), t = n.format.is("span", {"class": e});
          be(this).toggleClass("fr-active", t).attr("aria-selected", t)
        })
      }
    }
  ...
  }), be.FE.DefineIcon("inlineClass", {NAME: "tag"}), be.extend(be.FE.DEFAULTS, {
    inlineStyles: {
    ...
    return {
      apply: function (e) {
        ...
        } else i.html.insert('<span style="' + e + '">' + be.FE.INVISIBLE_SPACE + be.FE.MARKERS + "</span>")
      }
    }
  ...
  }), be.FE.DefineIcon("inlineStyle", {NAME: "paint-brush"}), be.extend(be.FE.DEFAULTS, {
    ...
    function l(e) {
      if (e) {
        ...
        if (0 < t.parents(p.opts.lineBreakerTags.join(",")).length) return e = t.parents(p.opts.lineBreakerTags.join(",")).get(0), 0 !== p.$el.find(e).length && be(e).is(p.opts.lineBreakerTags.join(",")) ? be(e) : null
      }
      return null
    }
    ...
    function n(e) {
      var t = i = null, n = null, r = p.doc.elementFromPoint(e.pageX - p.win.pageXOffset, e.pageY - p.win.pageYOffset);
    ...
    return {
      _init: function () {
        ...
        var t = i.selection.blocks();
        i.selection.save();
        for (var n = 0; n < t.length; n++) be(t[n]).css("line-height", e), "" === be(t[n]).attr("style") && be(t[n]).removeAttr("style");
        ...
        if (n.length) {
          var r = be(n[0]);
          t.find(".fr-command").each(function () {
            var e = be(this).data("param1"), t = 0 <= (r.attr("style") || "").indexOf("line-height: " + e + ";");
            be(this).toggleClass("fr-active", t).attr("aria-selected", t)
          })
        }
      }
    ...
    function a(e) {
      ...
      var r = n.offset().left + be(e).outerWidth() / 2, i = n.offset().top + n.outerHeight();
    ...
    function d() {
      ...
      if (t) {
        var n, r, i = be(t), a = e.find('input.fr-link-attr[type="text"]'),
          o = e.find('input.fr-link-attr[type="checkbox"]');
        for (n = 0; n < a.length; n++) (r = be(a[n])).val(i.attr(r.attr("name") || ""));
        for (o.prop("checked", !1), n = 0; n < o.length; n++) r = be(o[n]), i.attr(r.attr("name")) == r.data("checked") && r.prop("checked", !0);
    ...
    function c(e, t, n) {
      ...
      if (o) {
        ...
        for (var l = u(), d = 0; d < l.length; d++) (a = be(l[d])).attr(n), a.removeAttr("_moz_dirty");
    ...
    function g() {
      ...
      if (e) {
        ...
        var n = (f.image ? f.image.get() : null) || be(e), r = n.offset().left + n.outerWidth() / 2,
    ...
    return {
      _init: function () {
        ...
        for (n = 0; n < a.length; n++) r[(t = be(a[n])).attr("name")] ? t.val(r[t.attr("name")]) : "text" != t.attr("name") && t.val("");
        for (n = 0; n < o.length; n++) (t = be(o[n])).prop("checked", t.data("checked") == r[t.attr("name")]);
        f.accessibility.focusPopup(i)
      }, insertCallback: function () {
        var e, t, n = f.popups.get("link.insert"), r = n.find('input.fr-link-attr[type="text"]'),
          i = n.find('input.fr-link-attr[type="checkbox"]'), a = (r.filter('[name="href"]').val() || "").trim(),
          o = r.filter('[name="text"]').val(), s = {};
        for (t = 0; t < r.length; t++) e = be(r[t]), ["href", "text"].indexOf(e.attr("name")) < 0 && (s[e.attr("name")] = e.val());
        for (t = 0; t < i.length; t++) (e = be(i[t])).is(":checked") ? s[e.attr("name")] = e.data("checked") : s[e.attr("name")] = e.data("unchecked") || null;
  ...
  }, be.FE.DefineIcon("insertLink", {NAME: "link"}), be.FE.RegisterShortcut(be.FE.KEYCODE.K, "insertLink", null, "K"), be.FE.RegisterCommand("insertLink", {
    title: "Insert Link",
    undo: !1,
    focus: !0,
    refreshOnCallback: !1,
  ...
  }), be.FE.DefineIcon("linkEdit", {NAME: "edit"}), be.FE.RegisterCommand("linkEdit", {
    title: "Edit Link",
    undo: !1,
    refreshAfterCallback: !1,
    popup: !0,
    ...
    plugin: "link"
  }), be.FE.DefineIcon("linkRemove", {NAME: "unlink"}), be.FE.RegisterCommand("linkRemove", {
    title: "Unlink",
    callback: function () {
      this.link.remove()
    },
    ...
    plugin: "link"
  }), be.FE.DefineIcon("linkBack", {NAME: "arrow-left"}), be.FE.RegisterCommand("linkBack", {
    title: "Back",
    undo: !1,
    focus: !1,
    back: !0,
    ...
    plugin: "link"
  }), be.FE.DefineIcon("linkList", {NAME: "search"}), be.FE.RegisterCommand("linkList", {
    title: "Choose Link",
    type: "dropdown",
    focus: !1,
    undo: !1,
  ...
  }), be.FE.DefineIcon("imageLink", {NAME: "link"}), be.FE.RegisterCommand("imageLink", {
    title: "Insert Link",
    undo: !1,
    focus: !1,
    popup: !0,
    ...
    plugin: "link"
  }), be.FE.DefineIcon("linkStyle", {NAME: "magic"}), be.FE.RegisterCommand("linkStyle", {
    title: "Style",
    type: "dropdown",
    html: function () {
    ...
    refreshOnShow: function (e, t) {
      ...
      if (n) {
        var r = be(n);
        t.find(".fr-command").each(function () {
          var e = be(this).data("param1"), t = r.hasClass(e);
          be(this).toggleClass("fr-active", t).attr("aria-selected", t)
        })
      }
    },
    ...
    plugin: "link"
  }), be.extend(be.FE.DEFAULTS, {listAdvancedTypes: !0}), be.FE.PLUGINS.lists = function (f) {
    function p(e) {
    ...
    function a(e) {
      var t, n;
      for (t = e.length - 1; 0 <= t; t--) for (n = t - 1; 0 <= n; n--) if (be(e[n]).find(e[t]).length || e[n] == e[t]) {
        e.splice(t, 1);
        break
      }
      var r = [];
      for (t = 0; t < e.length; t++) {
        var i = be(e[t]), a = e[t].parentNode, o = i.attr("class");
    ...
    return {
      _init: function () {
        ...
        if (f.selection.save(), function (e, t) {
          ...
          for (n = 0; n < r.length; n++) "LI" == r[n].tagName && (be(r[n].parentNode).css("list-style-type", t), 0 === (be(r[n].parentNode).attr("style") || "").length && be(r[n].parentNode).removeAttr("style"))
        }
    ...
    plugin: "lists"
  }), be.FE.DefineIcon("formatUL", {NAME: "list-ul"}), be.FE.DefineIcon("formatOL", {NAME: "list-ol"}), be.extend(be.FE.DEFAULTS, {
    paragraphFormat: {
      N: "Normal",
      H1: "Heading 1",
      H2: "Heading 2",
  ...
  }), be.FE.DefineIcon("paragraphFormat", {NAME: "paragraph"}), be.extend(be.FE.DEFAULTS, {
    paragraphStyles: {
      "fr-text-gray": "Gray",
    ...
    return {
      _init: function () {
        ...
        s.selection.save();
        for (var a = be(i[0]).hasClass(e), o = 0; o < i.length; o++) be(i[o]).removeClass(r).toggleClass(e, !a), be(i[o]).hasClass("fr-temp-div") && be(i[o]).removeClass("fr-temp-div"), "" === be(i[o]).attr("class") && be(i[o]).removeAttr("class");
  ...
  }), be.FE.DefineIcon("paragraphStyle", {NAME: "magic"}), be.extend(be.FE.DEFAULTS, {html2pdf: window.html2pdf}), be.FE.PLUGINS.print = function (s) {
    return {
      run: function () {
        !function (e) {
  ...
  }, be.FE.DefineIcon("print", {NAME: "print"}), be.FE.RegisterCommand("print", {
    title: "Print",
    undo: !1,
    focus: !1,
    plugin: "print",
    ...
    be.FE.QUICK_INSERT_BUTTONS[e] = be.extend({undo: !0}, t)
    ...
    icon: "insertHR", title: "Insert Horizontal Line", callback: function () {
    ...
    return {
      apply: function (e) {
        r.selection.save(), r.html.wrap(!0, !0, !0, !0), r.selection.restore(), "increase" == e ? function () {
          ...
          var e, t = r.selection.blocks();
          for (e = 0; e < t.length; e++) "BLOCKQUOTE" != t[e].tagName && (t[e] = be(t[e]).parentsUntil(r.$el, "BLOCKQUOTE").get(0));
          for (r.selection.save(), e = 0; e < t.length; e++) t[e] && be(t[e]).replaceWith(t[e].innerHTML);
          r.html.unwrap(), r.selection.restore()
        }()
      }
    }
    ...
    plugin: "quote"
  }), be.FE.DefineIcon("quote", {NAME: "quote-left"}), be.extend(be.FE.DEFAULTS, {
    saveInterval: 1e4,
    saveURL: null,
    saveParams: {},
    saveParam: "body",
  ...
  }, be.FE.DefineIcon("save", {NAME: "floppy-o", FA5NAME: "save"}), be.FE.RegisterCommand("save", {
    title: "Save",
    undo: !1,
    focus: !1,
    refreshAfterCallback: !1,
    ...
    specialCharactersSets: [{
      ...
      list: [{"char": "&iexcl;", desc: "INVERTED EXCLAMATION MARK"}, {
        ...
        "char": "&uml;",
        desc: "DIAERESIS"
      }, {"char": "&copy;", desc: "COPYRIGHT SIGN"}, {"char": "&trade;", desc: "TRADEMARK SIGN"}, {
        "char": "&ordf;",
        desc: "FEMININE ORDINAL INDICATOR"
      }, {"char": "&laquo;", desc: "LEFT-POINTING DOUBLE ANGLE QUOTATION MARK"}, {
        "char": "&not;",
        desc: "NOT SIGN"
      }, {"char": "&reg;", desc: "REGISTERED SIGN"}, {"char": "&macr;", desc: "MACRON"}, {
        "char": "&deg;",
        desc: "DEGREE SIGN"
      }, {"char": "&plusmn;", desc: "PLUS-MINUS SIGN"}, {"char": "&sup2;", desc: "SUPERSCRIPT TWO"}, {
        "char": "&sup3;",
        desc: "SUPERSCRIPT THREE"
      }, {"char": "&acute;", desc: "ACUTE ACCENT"}, {"char": "&micro;", desc: "MICRO SIGN"}, {
        "char": "&para;",
        desc: "PILCROW SIGN"
      }, {"char": "&middot;", desc: "MIDDLE DOT"}, {"char": "&cedil;", desc: "CEDILLA"}, {
        "char": "&sup1;",
      ...
      list: [{"char": "&#x20A0", desc: "EURO-CURRENCY SIGN"}, {
        "char": "&#x20A1",
        desc: "COLON SIGN"
      }, {"char": "&#x20A2", desc: "CRUZEIRO SIGN"}, {"char": "&#x20A3", desc: "FRENCH FRANC SIGN"}, {
        "char": "&#x20A4",
        desc: "LIRA SIGN"
      }, {"char": "&#x20A5", desc: "MILL SIGN"}, {"char": "&#x20A6", desc: "NAIRA SIGN"}, {
        "char": "&#x20A7",
        desc: "PESETA SIGN"
      }, {"char": "&#x20A8", desc: "RUPEE SIGN"}, {"char": "&#x20A9", desc: "WON SIGN"}, {
        "char": "&#x20AA",
        desc: "NEW SHEQEL SIGN"
      }, {"char": "&#x20AB", desc: "DONG SIGN"}, {"char": "&#x20AC", desc: "EURO SIGN"}, {
        "char": "&#x20AD",
        desc: "KIP SIGN"
      }, {"char": "&#x20AE", desc: "TUGRIK SIGN"}, {"char": "&#x20AF", desc: "DRACHMA SIGN"}, {
        "char": "&#x20B0",
        desc: "GERMAN PENNY SYMBOL"
      }, {"char": "&#x20B1", desc: "PESO SIGN"}, {"char": "&#x20B2", desc: "GUARANI SIGN"}, {
        "char": "&#x20B3",
        desc: "AUSTRAL SIGN"
      }, {"char": "&#x20B4", desc: "HRYVNIA SIGN"}, {"char": "&#x20B5", desc: "CEDI SIGN"}, {
        "char": "&#x20B6",
      ...
      }, {"char": "&#x2194", desc: "LEFT RIGHT ARROW"}, {"char": "&#x2195", desc: "UP DOWN ARROW"}, {
        "char": "&#x2196",
      ...
      }, {"char": "&prod;", desc: "N-ARY PRODUCT"}, {"char": "&sum;", desc: "N-ARY SUMMATION"}, {
        "char": "&minus;",
        desc: "MINUS SIGN"
      }, {"char": "&lowast;", desc: "ASTERISK OPERATOR"}, {"char": "&radic;", desc: "SQUARE ROOT"}, {
        "char": "&prop;",
      ...
      }, {"char": "&ge;", desc: "GREATER-THAN OR EQUAL TO"}, {"char": "&sub;", desc: "SUBSET OF"}, {
        "char": "&sup;",
        desc: "SUPERSET OF"
      ...
      _init: function () {
        ...
        if (!o) {
          ...
          o = n.$modal, n.$head, l = n.$body, s.events.$on(be(s.o_win), "resize", function () {
            ...
            var t = o.data("instance") || s, n = be(e.currentTarget);
            t.specialCharacters.insert(n)
          }), s.events.$on(l, "keydown", function (e) {
            var t = e.which, n = l.find("span.fr-special-character:focus:first");
            if (!(n.length || t != be.FE.KEYCODE.F10 || s.keys.ctrlKey(e) || e.shiftKey) && e.altKey) return d(l.find("span.fr-special-character:first"), e), !1;
            ...
            if (t != be.FE.KEYCODE.ENTER || !n.length) return !0;
      ...
      if (i) {
        ...
        a || (a = function () {
          ...
          return T.events.$on(T.$wp, "scroll.table-colors", function () {
            ...
            } else be.FE.KEYCODE.ENTER == n && (T.button.exec(t), r = !1);
            return !1 === r && (e.preventDefault(), e.stopPropagation()), r
          }, !0), r;
          var h
      ...
      return T.events.$on(i, "mouseenter", ".fr-table-size .fr-select-table-size .fr-table-cell", function (e) {
        ...
        if (be.FE.KEYCODE.ARROW_UP == r || be.FE.KEYCODE.ARROW_DOWN == r || be.FE.KEYCODE.ARROW_LEFT == r || be.FE.KEYCODE.ARROW_RIGHT == r) {
          if (t.is("span.fr-table-cell")) {
            var i = t.parent().find("span.fr-table-cell"), a = i.index(t), o = T.opts.tableInsertMaxSize, s = a % o,
              l = Math.floor(a / o);
            ...
            var d = l * o + s, c = be(i.get(d));
            f(c), T.events.disableBlur(), c.focus(), n = !1
          }
        } else be.FE.KEYCODE.ENTER == r && (T.button.exec(t), n = !1);
        return !1 === n && (e.preventDefault(), e.stopPropagation()), n
      }, !0), i
    }
    ...
    function S(e) {
      ...
      return null == (e = e || null) && 0 < Q().length && (e = Z()), e && e.find("tr:visible").not(e.find("table tr")).each(function (s, e) {
        ...
        t.find("> th, > td").each(function (e, t) {
          for (var n = be(t), r = parseInt(n.attr("colspan"), 10) || 1, i = parseInt(n.attr("rowspan"), 10) || 1, a = s; a < s + i; a++) for (var o = l; o < l + r; o++) d[a] || (d[a] = []), d[a][o] ? l++ : d[a][o] = t;
          l += r
        })
      }), d
    }
    ...
    function R(e, t) {
      for (var n = 0; n < t.length; n++) for (var r = 0; r < t[n].length; r++) if (t[n][r] == e) return {row: n, col: r}
    }
    ...
    function N(e) {
      var t = w(e), n = be(e[t.min_i][t.min_j]), r = be(e[t.min_i][t.max_j]), i = be(e[t.max_i][t.min_j]);
      return {
        left: n.offset().left,
    ...
    function O(t, n) {
      if (be(t).is(n)) L(), be(t).addClass("fr-selected-cell"); else {
        x(), T.edit.off();
        var r = S(), i = R(t, r), a = R(n, r), o = function e(t, n, r, i, a) {
          var o, s, l, d, c = t, f = n, p = r, u = i;
          for (o = c; o <= f; o++) (1 < (parseInt(be(a[o][p]).attr("rowspan"), 10) || 1) || 1 < (parseInt(be(a[o][p]).attr("colspan"), 10) || 1)) && (d = y((l = R(a[o][p], a)).row, l.col, a), c = Math.min(l.row, c), f = Math.max(d.row, f), p = Math.min(l.col, p), u = Math.max(d.col, u)), (1 < (parseInt(be(a[o][u]).attr("rowspan"), 10) || 1) || 1 < (parseInt(be(a[o][u]).attr("colspan"), 10) || 1)) && (d = y((l = R(a[o][u], a)).row, l.col, a), c = Math.min(l.row, c), f = Math.max(d.row, f), p = Math.min(l.col, p), u = Math.max(d.col, u));
          for (s = p; s <= u; s++) (1 < (parseInt(be(a[c][s]).attr("rowspan"), 10) || 1) || 1 < (parseInt(be(a[c][s]).attr("colspan"), 10) || 1)) && (d = y((l = R(a[c][s], a)).row, l.col, a), c = Math.min(l.row, c), f = Math.max(d.row, f), p = Math.min(l.col, p), u = Math.max(d.col, u)), (1 < (parseInt(be(a[f][s]).attr("rowspan"), 10) || 1) || 1 < (parseInt(be(a[f][s]).attr("colspan"), 10) || 1)) && (d = y((l = R(a[f][s], a)).row, l.col, a), c = Math.min(l.row, c), f = Math.max(d.row, f), p = Math.min(l.col, p), u = Math.max(d.col, u));
        ...
        for (var s = o.min_i; s <= o.max_i; s++) for (var l = o.min_j; l <= o.max_j; l++) be(r[s][l]).addClass("fr-selected-cell")
      }
    }

    function I(e) {
      var t = null, n = be(e.target);
    ...
    function e(e) {
      var t = I(e);
      if ("false" == be(t).parents("[contenteditable]:not(.fr-element):not(.fr-img-caption):not(body):first").attr("contenteditable")) return !0;
          ...
          T.opts.iframe && (t -= T.$iframe.offset().left), A.data("release-position", t), A.removeData("max-left"), A.removeData("max-right"), function () {
            ...
            if (e !== t) {
              ...
              if (T.undo.canDo() || T.undo.saveStep(), null !== n && null !== r) {
                ...
                for (o = 0; o < d.length; o++) s = be(d[o][n]), l = be(d[o][r]), c[o] = s.outerWidth(), p[o] = l.outerWidth(), f[o] = c[o] / a * 100, u[o] = p[o] / a * 100;
                for (o = 0; o < d.length; o++) if (s = be(d[o][n]), l = be(d[o][r]), d[o][n] != d[o][r]) {
    ...
    function U(e, t) {
      var n = be(t), r = n.closest("table"), i = r.parent();
      if (t && "TD" != t.tagName && "TH" != t.tagName && (0 < n.closest("td").length ? t = n.closest("td") : 0 < n.closest("th").length && (t = n.closest("th"))), !t || "TD" != t.tagName && "TH" != t.tagName) A && n.get(0) != A.get(0) && n.parent().get(0) != A.get(0) && T.core.sameInstance(A) && B(); else {
        if (n = be(t), 0 === T.$el.find(n).length) return !1;
        ...
        if (Math.abs(e.pageX - a) <= T.opts.tableResizerOffset || Math.abs(o - e.pageX) <= T.opts.tableResizerOffset) {
          var s, l, d, c, f, p = S(r), u = R(t, p), h = y(u.row, u.col, p), g = r.offset().top, m = r.outerHeight() - 1;
    ...
    function K(e, t) {
      ...
      var n, r = be(t).find("tr:first"), i = e.pageX, a = 0, o = 0;
    ...
    function H(e, t) {
      if (T.$box.find(".fr-line-breaker").is(":visible")) return !1;
      s || q(), T.$box.append(s), s.data("instance", T);
      var n, r = be(t), i = e.pageY, a = 0, o = 0;
      ...
      T.opts.tableResizer && (!T.popups.areVisible() || T.popups.areVisible() && T.popups.isVisible("table.edit")) && U(e, t), !T.opts.tableInsertHelper || T.popups.areVisible() || T.$tb.hasClass("fr-inline") && T.$tb.is(":visible") || function (e, t) {
        if (0 === Q().length) {
          ...
          if (t && ("HTML" == t.tagName || "BODY" == t.tagName || T.node.isElement(t))) for (n = 1; n <= T.opts.tableInsertHelperOffset; n++) {
            if (r = T.doc.elementFromPoint(e.pageX - T.win.pageXOffset, e.pageY - T.win.pageYOffset + n), be(r).hasClass("fr-tooltip")) return;
            if (r && ("TH" == r.tagName || "TD" == r.tagName || "TABLE" == r.tagName) && (be(r).parents(".fr-wrapper").length || T.opts.iframe)) return K(e, be(r).closest("table"));
            if (i = T.doc.elementFromPoint(e.pageX - T.win.pageXOffset + n, e.pageY - T.win.pageYOffset), be(i).hasClass("fr-tooltip")) return;
            if (i && ("TH" == i.tagName || "TD" == i.tagName || "TABLE" == i.tagName) && (be(i).parents(".fr-wrapper").length || T.opts.iframe)) return H(e, be(i).closest("table"))
          }
    ...
    function Y(e, t) {
      var n, r = be(t[0][e]).outerWidth();
      for (n = 1; n < t.length; n++) r = Math.min(r, be(t[n][e]).outerWidth());
      return r
    }
    ...
    return {
      _init: function () {
          ...
          b = i = a = !1, T.events.$on(T.$el, "mousedown", e), T.popups.onShow("image.edit", function () {
            ...
            e.shiftKey ? !1 === function (e) {
              ...
              if (0 < t.length) {
                ...
                } else if (be.FE.KEYCODE.ARROW_UP == a && 0 < o.row) return O(n, i[o.row - 1][o.col]), !1
              }
              ...
              if (n.length && ("TD" == (n = n[0]).tagName || "TH" == n.tagName)) {
                ...
                if (r && "TABLE" == r.tagName && (be.FE.KEYCODE.ARROW_LEFT == t || be.FE.KEYCODE.ARROW_UP == t || be.FE.KEYCODE.ARROW_RIGHT == t || be.FE.KEYCODE.ARROW_DOWN == t) && (0 < Q().length && D(), T.browser.webkit && (be.FE.KEYCODE.ARROW_UP == t || be.FE.KEYCODE.ARROW_DOWN == t))) {
                  ...
                  if (i.nodeType == Node.TEXT_NODE && (be.FE.KEYCODE.ARROW_UP == t && i.previousSibling || be.FE.KEYCODE.ARROW_DOWN == t && i.nextSibling)) return;
                  e.preventDefault(), e.stopPropagation();
                  var a = S(be(r)), o = R(n, a);
        ...
        var n, r,
          ...
          a = 100 / t;
        for (n = 0; n < e; n++) {
          for (i += "<tr>", r = 0; r < t; r++) i += "<td" + (T.opts.tableDefaultWidth ? ' style="width: ' + a.toFixed(4) + '%;"' : "") + ">", 0 === n && 0 === r && (i += be.FE.MARKERS), i += "<br></td>";
          i += "</tr>"
        }
        ...
        if (0 < e.length) {
          ...
          if (0 === a.min_i && a.max_i == i.length - 1) h(); else {
            for (t = a.max_i; t >= a.min_i; t--) {
              for (r = be(e.find("tr").not(e.find("table tr")).get(t)), n = 0; n < i[t].length; n++) if (0 === n || i[t][n] != i[t][n - 1]) {
                var o = be(i[t][n]);
        ...
        if (0 < e.length) {
          ...
          if (0 === a.min_j && a.max_j == i[0].length - 1) h(); else {
            var o = 0;
            for (t = 0; t < i.length; t++) for (n = 0; n < i[0].length; n++) (r = be(i[t][n])).hasClass("fr-selected-cell") || (r.data("old-width", r.outerWidth() / e.outerWidth() * 100), (n < a.min_j || n > a.max_j) && (o += r.outerWidth() / e.outerWidth() * 100));
            for (o /= i.length, n = a.max_j; n >= a.min_j; n--) for (t = 0; t < i.length; t++) if (0 === t || i[t][n] != i[t - 1][n]) if (r = be(i[t][n]), 1 < (parseInt(r.attr("colspan"), 10) || 1)) {
        ...
        if (1 < Q().length && (0 === T.$el.find("th.fr-selected-cell").length || 0 === T.$el.find("td.fr-selected-cell").length)) {
          _();
          var e, t, n = w(S()), r = T.$el.find(".fr-selected-cell"), i = be(r[0]),
            a = i.parent().find(".fr-selected-cell"), o = i.closest("table"), s = i.html(), l = 0;
          for (e = 0; e < a.length; e++) l += be(a[e]).outerWidth();
          for (i.css("width", Math.min(100, l / o.outerWidth() * 100).toFixed(4) + "%"), n.min_j < n.max_j && i.attr("colspan", n.max_j - n.min_j + 1), n.min_i < n.max_i && i.attr("rowspan", n.max_i - n.min_i + 1), e = 1; e < r.length; e++) "<br>" != (t = be(r[e])).html() && "" !== t.html() && (s += "<br>" + t.html()), t.remove();
          i.html(s), T.selection.setAtEnd(i.get(0)), T.selection.restore(), T.toolbar.enable(), v(n.min_i, n.max_i, o);
          var d = o.find("tr:empty");
          for (e = d.length - 1; 0 <= e; e--) be(d[e]).remove();
          m(n.min_j, n.max_j, o), u()
        }
      }, splitCellVertically: function () {
        if (1 == Q().length) {
          var e = T.$el.find(".fr-selected-cell"), t = parseInt(e.attr("colspan"), 10) || 1,
            n = e.parent().outerWidth(), r = e.outerWidth(), i = e.clone().html("<br>"), a = S(), o = R(e.get(0), a);
          if (1 < t) {
            var s = Math.ceil(t / 2);
  ...
  }, be.FE.DefineIcon("insertTable", {NAME: "table"}), be.FE.RegisterCommand("insertTable", {
    title: "Insert Table",
    undo: !1,
    focus: !0,
    refreshOnCallback: !1,
  ...
  }), be.FE.DefineIcon("tableRows", {NAME: "bars"}), be.FE.RegisterCommand("tableRows", {
    type: "dropdown",
    focus: !1,
    title: "Row",
    options: {above: "Insert row above", below: "Insert row below", "delete": "Delete row"},
    html: function () {
      var e = '<ul class="fr-dropdown-list" role="presentation">', t = be.FE.COMMANDS.tableRows.options;
  ...
  }), be.FE.DefineIcon("tableColumns", {NAME: "bars fa-rotate-90"}), be.FE.RegisterCommand("tableColumns", {
    type: "dropdown",
    focus: !1,
    title: "Column",
    options: {before: "Insert column before", after: "Insert column after", "delete": "Delete column"},
    html: function () {
      var e = '<ul class="fr-dropdown-list" role="presentation">', t = be.FE.COMMANDS.tableColumns.options;
    ...
    html: function () {
      var e = '<ul class="fr-dropdown-list" role="presentation">', t = be.FE.COMMANDS.tableCells.options;
  ...
  }), be.FE.DefineIcon("tableRemove", {NAME: "trash"}), be.FE.RegisterCommand("tableRemove", {
    title: "Remove Table",
    focus: !1,
    callback: function () {
      this.table.remove()
    }
  }),be.FE.DefineIcon("tableStyle", {NAME: "paint-brush"}),be.FE.RegisterCommand("tableStyle", {
    title: "Table Style",
    type: "dropdown",
    focus: !1,
    html: function () {
  ...
  }),be.FE.DefineIcon("tableCellBackground", {NAME: "tint"}),be.FE.RegisterCommand("tableCellBackground", {
  ...
  }),be.FE.DefineIcon("tableBack", {NAME: "arrow-left"}),be.FE.RegisterCommand("tableBack", {
    title: "Back",
    undo: !1,
    focus: !1,
    back: !0,
    ...
    html: function () {
      var e = '<ul class="fr-dropdown-list" role="presentation">', t = be.FE.COMMANDS.tableCellVerticalAlign.options;
  ...
  }),be.FE.DefineIcon("tableCellHorizontalAlign", {NAME: "align-left"}),be.FE.DefineIcon("align-left", {NAME: "align-left"}),be.FE.DefineIcon("align-right", {NAME: "align-right"}),be.FE.DefineIcon("align-center", {NAME: "align-center"}),be.FE.DefineIcon("align-justify", {NAME: "align-justify"}),be.FE.RegisterCommand("tableCellHorizontalAlign", {
    type: "dropdown",
    focus: !1,
    title: "Horizontal Align",
    options: {left: "Align Left", center: "Align Center", right: "Align Right", justify: "Align Justify"},
    html: function () {
      var e = '<ul class="fr-dropdown-list" role="presentation">', t = be.FE.COMMANDS.tableCellHorizontalAlign.options;
  ...
  }),be.FE.DefineIcon("tableCellStyle", {NAME: "magic"}),be.FE.RegisterCommand("tableCellStyle", {
    title: "Cell Style",
    type: "dropdown",
    focus: !1,
    html: function () {
  ...
  }),be.FE.DefineIcon("tableColorRemove", {NAME: "eraser"}),be.FE.URLRegEx = "(^| |\\u00A0)(" + be.FE.LinkRegEx + "|([a-z0-9+-_.]{1,}@[a-z0-9+-_.]{1,}\\.[a-z0-9+-_]{1,}))$",be.FE.PLUGINS.url = function (a) {
    var o = null;
    ...
    var s, c, p, u, r, n, d = "https://i.froala.com/upload", l = 2, h = 3, g = 4, m = 5, v = 6, i = {};
    ...
    function o(e) {
      ...
      var n, r = "", i = f.opts.videoInsertButtons.indexOf("videoUpload"),
        a = f.opts.videoInsertButtons.indexOf("videoByURL"), o = f.opts.videoInsertButtons.indexOf("videoEmbed");
    ...
    function k() {
      ...
      for (e = 0; e < t.length; e++) n.push(t[e].getAttribute("src")), be(t[e]).toggleClass("fr-draggable", f.opts.videoMove), "" === t[e].getAttribute("class") && t[e].removeAttribute("class"), "" === t[e].getAttribute("style") && t[e].removeAttribute("style");
      if (r) for (e = 0; e < r.length; e++) n.indexOf(r[e].getAttribute("src")) < 0 && f.events.trigger("video.removed", [be(r[e])]);
      r = t
    }
    ...
    function M(e) {
      ...
      for (var t = 0; t < be.FE.INSTANCES.length; t++) be.FE.INSTANCES[t] != f && be.FE.INSTANCES[t].events.trigger("video.hideResizer");
    ...
    function U(e) {
      if (void 0 !== e && 0 < e.length) {
        ...
        var t, n = e[0];
        if ((null === f.opts.videoUploadURL || f.opts.videoUploadURL == d) && !f.opts.videoUploadToS3) return s = n, (l = new FileReader).addEventListener("load", function () {
          l.result;
          for (var e = atob(l.result.split(",")[1]), t = [], n = 0; n < e.length; n++) t.push(e.charCodeAt(n));
          A(window.URL.createObjectURL(new Blob([new Uint8Array(t)], {type: s.type})), !1, null, u)
    ...
    function q() {
      f.$el.find("video").filter(function () {
        ...
        if (f.browser.safari && this.getAttribute("src") && this.setAttribute("src", this.src), 0 < be(this).parents("span.fr-video").length) return !1;
    ...
    return i[1] = "Video cannot be loaded from the passed link.", i[l] = "No link in upload response.", i[h] = "Error during file upload.", i[g] = "Parsing response failed.", i[m] = "File is too large.", i[v] = "Video file type is invalid.", i[7] = "Files can be uploaded only to same domain in IE 8 and IE 9.", f.shared.vid_exit_flag = !1, {
      _init: function () {
        ...
        var t = null;
        if (/^http/.test(e) || (e = "https://" + e), f.helpers.isURL(e)) for (var n = 0; n < be.FE.VIDEO_PROVIDERS.length; n++) {
        ...
        var t = u.find("iframe, embed, video"), n = t.offset().left + t.width() / 2, r = t.offset().top + t.height();
    ...
    NAME: "video-camera",
    FA5NAME: "camera"
  }),be.FE.DefineIcon("videoByURL", {NAME: "link"}),be.FE.RegisterCommand("videoByURL", {
    title: "By URL",
    undo: !1,
    focus: !1,
    toggle: !0,
  ...
  }),be.FE.DefineIcon("videoEmbed", {NAME: "code"}),be.FE.RegisterCommand("videoEmbed", {
    title: "Embedded Code",
    undo: !1,
    focus: !1,
    toggle: !0,
  ...
  }),be.FE.DefineIcon("videoUpload", {NAME: "upload"}),be.FE.RegisterCommand("videoUpload", {
    title: "Upload Video",
    undo: !1,
    focus: !1,
    toggle: !0,
  ...
  }),be.FE.DefineIcon("videoDisplay", {NAME: "star"}),be.FE.RegisterCommand("videoDisplay", {
    title: "Display",
    type: "dropdown",
    options: {inline: "Inline", block: "Break Text"},
    callback: function (e, t) {
  ...
  }),be.FE.DefineIcon("video-align", {NAME: "align-left"}),be.FE.DefineIcon("video-align-left", {NAME: "align-left"}),be.FE.DefineIcon("video-align-right", {NAME: "align-right"}),be.FE.DefineIcon("video-align-center", {NAME: "align-justify"}),be.FE.DefineIcon("videoAlign", {NAME: "align-center"}),be.FE.RegisterCommand("videoAlign", {
    type: "dropdown",
    title: "Align",
    options: {left: "Align Left", center: "None", right: "Align Right"},
    html: function () {
      var e = '<ul class="fr-dropdown-list" role="presentation">', t = be.FE.COMMANDS.videoAlign.options;
  ...
  }),be.FE.DefineIcon("videoRemove", {NAME: "trash"}),be.FE.RegisterCommand("videoRemove", {
    title: "Remove",
    callback: function () {
      this.video.remove()
    }
  }),be.FE.DefineIcon("videoSize", {NAME: "arrows-alt"}),be.FE.RegisterCommand("videoSize", {
    undo: !1,
    focus: !1,
    popup: !0,
    title: "Change Size",
  ...
  }),be.FE.DefineIcon("videoBack", {NAME: "arrow-left"}),be.FE.RegisterCommand("videoBack", {
    title: "Back",
    undo: !1,
    focus: !1,
    back: !0,
      ...
      e || (T.opts.wordAllowedStyleProps = []), 0 === r.indexOf("<colgroup>") && (r = "<table>" + r + "</table>"), r = function (e, t) {
        ...
        c(i, function (e) {
          if (e.nodeType == Node.TEXT_NODE && /\n|\u00a0|\r/.test(e.data)) {
            if (!/\S| /.test(e.data)) return e.data == be.FE.UNICODE_NBSP ? (e.data = "\u200b", !0) : 1 == e.data.length && 10 == e.data.charCodeAt(0) ? (e.data = " ", !0) : (A(e), !1);
